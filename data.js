...
window.ESSAYS = [
  ...
  },
  {
    ...
    url: "https://0x4d44.github.io/audio-compression/",
    illustration: "ill-lossy",
  ...
  {
    slug: "f1gp-internals",
    title: "Inside Formula One Grand Prix",
    tagline: "How Geoff Crammond's 1991 simulator works inside \u2014 track files, a 26-car field, race control, the 3D renderer, sound and saves \u2014 and the day-by-day story of porting it, byte-faithful, to a Rust host in twenty-four days. Twelve chapters, original diagrams, no build step.",
    url: "https://0x4d44.github.io/f1gp-internals/",
    illustration: "ill-f1gp",
    date: "2026-09-23T20:00:00+01:00",
    year: 1991,
    readingMin: 321,
    words: 70537,
  ...
  },
  {
    ...
    title: "Social Situations as Learnable Systems",
    tagline: "A practical XYZ framework for making social situations explicit: separate liking, interaction depth and predictability, then turn ambiguous settings into small state machines with reusable responses. Interactive maps for lectures, labs, group work, staff conversations and open social events. Vanilla JavaScript; no build step.",
    url: "https://0x4d44.github.io/social-situations/",
    illustration: "ill-teenbrain",
    date: "2026-09-18T17:00:00+01:00",
    year: 2026,
    readingMin: 8,
    words: 1650,
  ...
  {
    slug: "winrisk",
    title: "Inside WINRISK",
    tagline: "An interactive autopsy of a 1992 Windows game: reproduce a borrowed-die combat bug, explore ten executable segments, compare real territory polygons, and follow nine binary repairs. Eight chapters and eleven instruments, with exact offsets and test evidence. Vanilla JavaScript and SVG; no build step.",
    url: "https://0x4d44.github.io/winrisk/",
    illustration: "ill-pc",
    date: "2026-09-15T16:00:00+01:00",
    year: 1992,
    readingMin: 20,
  ...
  },
  {
    ...
    url: "https://0x4d44.github.io/OxAlphaRally/",
    illustration: "ill-rally",
    date: "2026-08-26",
    year: 2026,
    tags: ["games", "simulation", "transport"],
...
window.COLLECTIONS = [
  { id: "life", name: "Life", icon: "ill-flange",
    ...
    slugs: ["social-situations", "master-flanger"] },
  ...
  { id: "health", name: "Health & Fitness", icon: "ill-run",
    ...
    slugs: ["social-situations", "polymyalgia", "morning-run", "shipshape"] },
  ...
  { id: "code", name: "Code", icon: "ill-loc",
    ...
    slugs: ["f1gp-internals", "mos-6502", "winrisk", "mdtpw", "mdmdview", "mdkloc", "readex", "ropus", "mdmcp", "nonogram",
