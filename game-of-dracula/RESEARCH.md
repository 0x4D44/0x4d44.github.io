...
**The crypt is a dead end.** The instruction page establishes that later victims are carried to the vault, and the surviving board photographs place the vault in the castle's lower left, but they do not fix its connections. An early digital layout wired it straight into the left-hand HOME run, three stones from escape while the START stones sit eleven to thirteen away — and because every red sector moves a guest exactly three or four stones, both counts landed on the doorway. Being caught became the fastest way to win: across four thousand automata games a guest who had been carried to the vault won about 72% of the time against about 14% for one who never was. The crypt is therefore cut as a dead-end stair descending from the vault antechamber. It remains a hidey-hole, as the evidence requires, and it remains escapable, but the climb out is nine stones and no single spin can carry a victim home. The same measurement now reads about 23% against 25%, so capture costs tempo instead of handing over the game.
