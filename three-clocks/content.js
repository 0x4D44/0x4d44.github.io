...
(function (w) {
  ...
  TC.ai = {
    ...
    blocks: [
      ...
      { p: "The measurable inputs are unambiguous and their rate is extraordinary. Training compute for frontier models grew by a factor of four to five per year from 2010 to 2024 — roughly six tenths of an order of magnitude annually, sustained for fourteen years. Algorithmic efficiency added its own contribution: the compute required to reach a fixed capability has fallen at something like a third of an order of magnitude a year on top of the hardware gains. Compounded, the frontier moved about six effective orders of magnitude between GPT-3 in 2020 and the 2026 systems." },
  ...
  TC.peace = {
    ...
    blocks: [
      ...
      { p: "The data do not support complacency in any case. The Uppsala Conflict Data Programme recorded 65 state-involved conflicts in 2025 — the highest number since the series began in 1946. Thirteen passed the thousand-deaths threshold that defines a war, the most since 1992. Around 244,600 people died in organised violence, the second-worst year since the Rwandan genocide; Russia's war in Ukraine accounted for about 94,700 of them, some 62% of all battle deaths. Deaths from one-sided violence against civilians rose more than fourfold to 76,500, the highest since 1994." },
