...
(function (w) {
  ...
  TC.ai = {
    ...
    blocks: [
      ...
      { p: "There is an obvious objection here and it deserves answering rather than ducking: a third of the workforce picking a technology up in three years is *fast*, and it looks like a refutation of any thesis with the word decades in it. It is not, and the reason is the most useful thing the electrification story has to teach. Factories did not take forty years to buy electric motors. They bought them quickly, and bolted them where the steam engine\u2019s driveshaft had been \u2014 one big motor turning the same overhead line-shaft, which captured almost none of the benefit. The forty years went on discovering that the point of electricity was that you could put a small motor in every machine and lay the floor out by workflow instead of by proximity to the shaft, and then on rebuilding the floors. **Adoption of the tool is fast; reorganisation around the tool is slow.** Thirty-six per cent of workers using a chat window to do their existing job faster is the drop-in motor. The reorganisation has barely started." },
  ...
  TC.peace = {
    ...
    blocks: [
      ...
      { p: "Direct war between great powers since 1815, on a strict reading — both sides recognised great powers, regular forces in sustained combat: the Crimean War, the Austro-Prussian War, the Franco-Prussian War, the Russo-Japanese War, and the two world wars. Six in 210 years is about 2.9% a year. The count is contestable and the contest matters: Jack Levy's canonical coding of great-power war finds rather more, depending on how the wars of Italian and German unification are treated, which would push the rate up rather than down. Since 1945, with nuclear weapons in the picture, the count is one — American and Chinese forces fighting each other in Korea — or zero on a stricter reading, giving between 0% and 1.2% a year. Take a figure in that range, apply it across the seventy-five years to 2100, and the implication is stark. **At anything like the historical base rate, a direct great-power war before 2100 is more likely than not.** That is not a forecast of doom; it is an observation about what a small annual probability does when compounded over three quarters of a century, and it is the single most important piece of arithmetic on this site. It is also the claim here most sensitive to a definitional choice: restrict the reference period to the nuclear era and take the strict reading, and the rate falls towards zero and the conclusion dissolves. Which is precisely the question — whether 1945 began a new process or merely a quiet stretch of the old one — and it is not settled by counting." },
