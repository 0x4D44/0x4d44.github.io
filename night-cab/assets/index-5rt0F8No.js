...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function Vl(){return new _n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ha(),fragmentShader:`
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function Wl(){return new _n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ha(),fragmentShader:`
	...
	`}class wd extends Cn{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const n={width:t,height:t,depth:1},s=[n,n,n,n,n,n];this.texture=new Md(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
#define LOW_PRECISION`),t}const k_={[Gr]:"SHADOWMAP_TYPE_PCF",[Xs]:"SHADOWMAP_TYPE_VSM"};function V_(i){return k_[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const W_={[Pi]:"ENVMAP_TYPE_CUBE",[ms]:"ENVMAP_TYPE_CUBE",[ua]:"ENVMAP_TYPE_CUBE_UV"};function X_(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":W_[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Y_={[ms]:"ENVMAP_MODE_REFRACTION"};function q_(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Y_[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const $_={[Zu]:"ENVMAP_BLENDING_MULTIPLY",[Nf]:"ENVMAP_BLENDING_MIX",[Ff]:"ENVMAP_BLENDING_ADD"};function K_(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":$_[i.combine]||"ENVMAP_BLENDING_NONE"}function Z_(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function j_(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=V_(e),l=X_(e),u=q_(e),h=K_(e),d=Z_(e),p=U_(e),g=N_(r),v=s.createProgram();let m,f,x=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Ys).join(`
`)),a=uc(a),a=tu(a,e),a=eu(a,e),o=uc(o),o=tu(o,e),o=eu(o,e),a=nu(a),o=nu(o),e.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
`)+`
`+f);const E=x+m+a,S=x+f+o,w=jl(s,s.VERTEX_SHADER,E),b=jl(s,s.FRAGMENT_SHADER,S);s.attachShader(v,w),s.attachShader(v,b),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function T(C){if(i.debug.checkShaderErrors){const P=s.getProgramInfoLog(v)||"",L=s.getShaderInfoLog(w)||"",B=s.getShaderInfoLog(b)||"",N=P.trim(),F=L.trim(),H=B.trim();let Z=!0,$=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,w,b);else{const Q=Ql(s,w,"vertex"),ct=Ql(s,b,"fragment");ee("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`,fx=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],px=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],ou=new te,zs=new U,no=new U;function mx(i,t,e){let n=new Bc;const s=new zt,r=new zt,a=new _e,o=new Tp,c=new Rp,l={},u=e.maxTextureSize,h={[li]:Ge,[Ge]:li,[An]:An},d=new _n({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new zt},radius:{value:4}},vertexShader:dx,fragmentShader:hx}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new Me;g.setAttribute("position",new Fe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Ft(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Gr;let f=this.type;this.render=function(b,T,_){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;this.type===Ku&&(Gt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Gr);const y=i.getRenderTarget(),I=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),P=i.state;P.setBlending(Hn),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);const L=f!==this.type;L&&T.traverse(function(B){B.material&&(Array.isArray(B.material)?B.material.forEach(N=>N.needsUpdate=!0):B.material.needsUpdate=!0)});for(let B=0,N=b.length;B<N;B++){const F=b[B],H=F.shadow;if(H===void 0){Gt("WebGLShadowMap:",F,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);const Z=H.getFrameExtents();s.multiply(Z),r.copy(H.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/Z.x),s.x=r.x*Z.x,H.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/Z.y),s.y=r.y*Z.y,H.mapSize.y=r.y));const $=i.state.buffers.depth.getReversed();if(H.camera._reversedDepth=$,H.map===null||L===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===Xs){if(F.isPointLight){Gt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new Cn(s.x,s.y,{format:gs,type:Xn,minFilter:Re,magFilter:Re,generateMipmaps:!1}),H.map.texture.name=F.name+".shadowMap",H.map.depthTexture=new Js(s.x,s.y,gn),H.map.depthTexture.name=F.name+".shadowMapDepth",H.map.depthTexture.format=Yn,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Ne,H.map.depthTexture.magFilter=Ne}else F.isPointLight?(H.map=new wd(s.x),H.map.depthTexture=new Sp(s.x,Ln)):(H.map=new Cn(s.x,s.y),H.map.depthTexture=new Js(s.x,s.y,Ln)),H.map.depthTexture.name=F.name+".shadowMap",H.map.depthTexture.format=Yn,this.type===Gr?(H.map.depthTexture.compareFunction=$?Dc:Lc,H.map.depthTexture.minFilter=Re,H.map.depthTexture.magFilter=Re):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Ne,H.map.depthTexture.magFilter=Ne);H.camera.updateProjectionMatrix()}const Q=H.map.isWebGLCubeRenderTarget?6:1;for(let ct=0;ct<Q;ct++){if(H.map.isWebGLCubeRenderTarget)i.setRenderTarget(H.map,ct),i.clear();else{ct===0&&(i.setRenderTarget(H.map),i.clear());const st=H.getViewport(ct);a.set(r.x*st.x,r.y*st.y,r.x*st.z,r.y*st.w),P.viewport(a)}if(F.isPointLight){const st=H.camera,Pt=H.matrix,$t=F.distance||st.far;$t!==st.far&&(st.far=$t,st.updateProjectionMatrix()),zs.setFromMatrixPosition(F.matrixWorld),st.position.copy(zs),no.copy(st.position),no.add(fx[ct]),st.up.copy(px[ct]),st.lookAt(no),st.updateMatrixWorld(),Pt.makeTranslation(-zs.x,-zs.y,-zs.z),ou.multiplyMatrices(st.projectionMatrix,st.matrixWorldInverse),H._frustum.setFromProjectionMatrix(ou,st.coordinateSystem,st.reversedDepth)}else H.updateMatrices(F);n=H.getFrustum(),S(T,_,H.camera,F,this.type)}H.isPointLightShadow!==!0&&this.type===Xs&&x(H,_),H.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(y,I,C)};function x(b,T){const _=t.update(v);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Cn(s.x,s.y,{format:gs,type:Xn})),d.uniforms.shadow_pass.value=b.map.depthTexture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(T,null,_,d,v,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(T,null,_,p,v,null)}function E(b,T,_,y){let I=null;const C=_.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(C!==void 0)I=C;else if(I=_.isPointLight===!0?c:o,i.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0||T.alphaToCoverage===!0){const P=I.uuid,L=T.uuid;let B=l[P];B===void 0&&(B={},l[P]=B);let N=B[L];N===void 0&&(N=I.clone(),B[L]=N,T.addEventListener("dispose",w)),I=N}if(I.visible=T.visible,I.wireframe=T.wireframe,y===Xs?I.side=T.shadowSide!==null?T.shadowSide:T.side:I.side=T.shadowSide!==null?T.shadowSide:h[T.side],I.alphaMap=T.alphaMap,I.alphaTest=T.alphaToCoverage===!0?.5:T.alphaTest,I.map=T.map,I.clipShadows=T.clipShadows,I.clippingPlanes=T.clippingPlanes,I.clipIntersection=T.clipIntersection,I.displacementMap=T.displacementMap,I.displacementScale=T.displacementScale,I.displacementBias=T.displacementBias,I.wireframeLinewidth=T.wireframeLinewidth,I.linewidth=T.linewidth,_.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const P=i.properties.get(I);P.light=_}return I}function S(b,T,_,y,I){if(b.visible===!1)return;if(b.layers.test(T.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&I===Xs)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,b.matrixWorld);const L=t.update(b),B=b.material;if(Array.isArray(B)){const N=L.groups;for(let F=0,H=N.length;F<H;F++){const Z=N[F],$=B[Z.materialIndex];if($&&$.visible){const Q=E(b,$,y,I);b.onBeforeShadow(i,b,T,_,L,Q,Z),i.renderBufferDirect(_,null,L,Q,b,Z),b.onAfterShadow(i,b,T,_,L,Q,Z)}}}else if(B.visible){const N=E(b,B,y,I);b.onBeforeShadow(i,b,T,_,L,N,null),i.renderBufferDirect(_,null,L,N,b,null),b.onAfterShadow(i,b,T,_,L,N,null)}}const P=b.children;for(let L=0,B=P.length;L<B;L++)S(P[L],T,_,y,I)}function w(b){b.target.removeEventListener("dispose",w);for(const _ in l){const y=l[_],I=b.target.uuid;I in y&&(y[I].dispose(),delete y[I])}}}function gx(i,t){function e(){let O=!1;const ut=new _e;let ot=null;const mt=new _e(0,0,0,0);return{setMask:function(et){ot!==et&&!O&&(i.colorMask(et,et,et,et),ot=et)},setLocked:function(et){O=et},setClear:function(et,X,St,q,it){it===!0&&(et*=q,X*=q,St*=q),ut.set(et,X,St,q),mt.equals(ut)===!1&&(i.clearColor(et,X,St,q),mt.copy(ut))},reset:function(){O=!1,ot=null,mt.set(-1,0,0,0)}}}function n(){let O=!1,ut=!1,ot=null,mt=null,et=null;return{setReversed:function(X){if(ut!==X){const St=t.get("EXT_clip_control");X?St.clipControlEXT(St.LOWER_LEFT_EXT,St.ZERO_TO_ONE_EXT):St.clipControlEXT(St.LOWER_LEFT_EXT,St.NEGATIVE_ONE_TO_ONE_EXT),ut=X;const q=et;et=null,this.setClear(q)}},getReversed:function(){return ut},setTest:function(X){X?rt(i.DEPTH_TEST):nt(i.DEPTH_TEST)},setMask:function(X){ot!==X&&!O&&(i.depthMask(X),ot=X)},setFunc:function(X){if(ut&&(X=Kf[X]),mt!==X){switch(X){case vo:i.depthFunc(i.NEVER);break;case Mo:i.depthFunc(i.ALWAYS);break;case So:i.depthFunc(i.LESS);break;case ps:i.depthFunc(i.LEQUAL);break;case Eo:i.depthFunc(i.EQUAL);break;case yo:i.depthFunc(i.GEQUAL);break;case bo:i.depthFunc(i.GREATER);break;case Ao:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}mt=X}},setLocked:function(X){O=X},setClear:function(X){et!==X&&(et=X,ut&&(X=1-X),i.clearDepth(X))},reset:function(){O=!1,ot=null,mt=null,et=null,ut=!1}}}function s(){let O=!1,ut=null,ot=null,mt=null,et=null,X=null,St=null,q=null,it=null;return{setTest:function(wt){O||(wt?rt(i.STENCIL_TEST):nt(i.STENCIL_TEST))},setMask:function(wt){ut!==wt&&!O&&(i.stencilMask(wt),ut=wt)},setFunc:function(wt,Nt,me){(ot!==wt||mt!==Nt||et!==me)&&(i.stencilFunc(wt,Nt,me),ot=wt,mt=Nt,et=me)},setOp:function(wt,Nt,me){(X!==wt||St!==Nt||q!==me)&&(i.stencilOp(wt,Nt,me),X=wt,St=Nt,q=me)},setLocked:function(wt){O=wt},setClear:function(wt){it!==wt&&(i.clearStencil(wt),it=wt)},reset:function(){O=!1,ut=null,ot=null,mt=null,et=null,X=null,St=null,q=null,it=null}}}const r=new e,a=new n,o=new s,c=new WeakMap,l=new WeakMap;let u={},h={},d=new WeakMap,p=[],g=null,v=!1,m=null,f=null,x=null,E=null,S=null,w=null,b=null,T=new Bt(0,0,0),_=0,y=!1,I=null,C=null,P=null,L=null,B=null;const N=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,H=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(Z)[1]),F=H>=1):Z.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),F=H>=2);let $=null,Q={};const ct=i.getParameter(i.SCISSOR_BOX),st=i.getParameter(i.VIEWPORT),Pt=new _e().fromArray(ct),$t=new _e().fromArray(st);function ie(O,ut,ot,mt){const et=new Uint8Array(4),X=i.createTexture();i.bindTexture(O,X),i.texParameteri(O,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(O,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let St=0;St<ot;St++)O===i.TEXTURE_3D||O===i.TEXTURE_2D_ARRAY?i.texImage3D(ut,0,i.RGBA,1,1,mt,0,i.RGBA,i.UNSIGNED_BYTE,et):i.texImage2D(ut+St,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,et);return X}const K={};K[i.TEXTURE_2D]=ie(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=ie(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=ie(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=ie(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),rt(i.DEPTH_TEST),a.setFunc(ps),gt(!1),Zt(rl),rt(i.CULL_FACE),Kt(Hn);function rt(O){u[O]!==!0&&(i.enable(O),u[O]=!0)}function nt(O){u[O]!==!1&&(i.disable(O),u[O]=!1)}function Ot(O,ut){return h[O]!==ut?(i.bindFramebuffer(O,ut),h[O]=ut,O===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ut),O===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ut),!0):!1}function At(O,ut){let ot=p,mt=!1;if(O){ot=d.get(ut),ot===void 0&&(ot=[],d.set(ut,ot));const et=O.textures;if(ot.length!==et.length||ot[0]!==i.COLOR_ATTACHMENT0){for(let X=0,St=et.length;X<St;X++)ot[X]=i.COLOR_ATTACHMENT0+X;ot.length=et.length,mt=!0}}else ot[0]!==i.BACK&&(ot[0]=i.BACK,mt=!0);mt&&i.drawBuffers(ot)}function Lt(O){return g!==O?(i.useProgram(O),g=O,!0):!1}const ae={[Si]:i.FUNC_ADD,[xf]:i.FUNC_SUBTRACT,[vf]:i.FUNC_REVERSE_SUBTRACT};ae[Mf]=i.MIN,ae[Sf]=i.MAX;const Yt={[Ef]:i.ZERO,[yf]:i.ONE,[bf]:i.SRC_COLOR,[_o]:i.SRC_ALPHA,[Pf]:i.SRC_ALPHA_SATURATE,[Rf]:i.DST_COLOR,[wf]:i.DST_ALPHA,[Af]:i.ONE_MINUS_SRC_COLOR,[xo]:i.ONE_MINUS_SRC_ALPHA,[Cf]:i.ONE_MINUS_DST_COLOR,[Tf]:i.ONE_MINUS_DST_ALPHA,[Lf]:i.CONSTANT_COLOR,[Df]:i.ONE_MINUS_CONSTANT_COLOR,[If]:i.CONSTANT_ALPHA,[Uf]:i.ONE_MINUS_CONSTANT_ALPHA};function Kt(O,ut,ot,mt,et,X,St,q,it,wt){if(O===Hn){v===!0&&(nt(i.BLEND),v=!1);return}if(v===!1&&(rt(i.BLEND),v=!0),O!==_f){if(O!==m||wt!==y){if((f!==Si||S!==Si)&&(i.blendEquation(i.FUNC_ADD),f=Si,S=Si),wt)switch(O){case ds:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case jr:i.blendFunc(i.ONE,i.ONE);break;case al:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ol:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:ee("WebGLState: Invalid blending: ",O);break}else switch(O){case ds:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case jr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case al:ee("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ol:ee("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ee("WebGLState: Invalid blending: ",O);break}x=null,E=null,w=null,b=null,T.set(0,0,0),_=0,m=O,y=wt}return}et=et||ut,X=X||ot,St=St||mt,(ut!==f||et!==S)&&(i.blendEquationSeparate(ae[ut],ae[et]),f=ut,S=et),(ot!==x||mt!==E||X!==w||St!==b)&&(i.blendFuncSeparate(Yt[ot],Yt[mt],Yt[X],Yt[St]),x=ot,E=mt,w=X,b=St),(q.equals(T)===!1||it!==_)&&(i.blendColor(q.r,q.g,q.b,it),T.copy(q),_=it),m=O,y=!1}function se(O,ut){O.side===An?nt(i.CULL_FACE):rt(i.CULL_FACE);let ot=O.side===Ge;ut&&(ot=!ot),gt(ot),O.blending===ds&&O.transparent===!1?Kt(Hn):Kt(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),a.setFunc(O.depthFunc),a.setTest(O.depthTest),a.setMask(O.depthWrite),r.setMask(O.colorWrite);const mt=O.stencilWrite;o.setTest(mt),mt&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),Qt(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?rt(i.SAMPLE_ALPHA_TO_COVERAGE):nt(i.SAMPLE_ALPHA_TO_COVERAGE)}function gt(O){I!==O&&(O?i.frontFace(i.CW):i.frontFace(i.CCW),I=O)}function Zt(O){O!==mf?(rt(i.CULL_FACE),O!==C&&(O===rl?i.cullFace(i.BACK):O===gf?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):nt(i.CULL_FACE),C=O}function D(O){O!==P&&(F&&i.lineWidth(O),P=O)}function Qt(O,ut,ot){O?(rt(i.POLYGON_OFFSET_FILL),(L!==ut||B!==ot)&&(L=ut,B=ot,a.getReversed()&&(ut=-ut),i.polygonOffset(ut,ot))):nt(i.POLYGON_OFFSET_FILL)}function It(O){O?rt(i.SCISSOR_TEST):nt(i.SCISSOR_TEST)}function jt(O){O===void 0&&(O=i.TEXTURE0+N-1),$!==O&&(i.activeTexture(O),$=O)}function _t(O,ut,ot){ot===void 0&&($===null?ot=i.TEXTURE0+N-1:ot=$);let mt=Q[ot];mt===void 0&&(mt={type:void 0,texture:void 0},Q[ot]=mt),(mt.type!==O||mt.texture!==ut)&&($!==ot&&(i.activeTexture(ot),$=ot),i.bindTexture(O,ut||K[O]),mt.type=O,mt.texture=ut)}function R(){const O=Q[$];O!==void 0&&O.type!==void 0&&(i.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function M(){try{i.compressedTexImage2D(...arguments)}catch(O){ee("WebGLState:",O)}}function z(){try{i.compressedTexImage3D(...arguments)}catch(O){ee("WebGLState:",O)}}function j(){try{i.texSubImage2D(...arguments)}catch(O){ee("WebGLState:",O)}}function J(){try{i.texSubImage3D(...arguments)}catch(O){ee("WebGLState:",O)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(O){ee("WebGLState:",O)}}function Mt(){try{i.compressedTexSubImage3D(...arguments)}catch(O){ee("WebGLState:",O)}}function lt(){try{i.texStorage2D(...arguments)}catch(O){ee("WebGLState:",O)}}function Rt(){try{i.texStorage3D(...arguments)}catch(O){ee("WebGLState:",O)}}function Ut(){try{i.texImage2D(...arguments)}catch(O){ee("WebGLState:",O)}}function tt(){try{i.texImage3D(...arguments)}catch(O){ee("WebGLState:",O)}}function at(O){Pt.equals(O)===!1&&(i.scissor(O.x,O.y,O.z,O.w),Pt.copy(O))}function vt(O){$t.equals(O)===!1&&(i.viewport(O.x,O.y,O.z,O.w),$t.copy(O))}function Et(O,ut){let ot=l.get(ut);ot===void 0&&(ot=new WeakMap,l.set(ut,ot));let mt=ot.get(O);mt===void 0&&(mt=i.getUniformBlockIndex(ut,O.name),ot.set(O,mt))}function pt(O,ut){const mt=l.get(ut).get(O);c.get(ut)!==mt&&(i.uniformBlockBinding(ut,mt,O.__bindingPointIndex),c.set(ut,mt))}function Ht(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},$=null,Q={},h={},d=new WeakMap,p=[],g=null,v=!1,m=null,f=null,x=null,E=null,S=null,w=null,b=null,T=new Bt(0,0,0),_=0,y=!1,I=null,C=null,P=null,L=null,B=null,Pt.set(0,0,i.canvas.width,i.canvas.height),$t.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:rt,disable:nt,bindFramebuffer:Ot,drawBuffers:At,useProgram:Lt,setBlending:Kt,setMaterial:se,setFlipSided:gt,setCullFace:Zt,setLineWidth:D,setPolygonOffset:Qt,setScissorTest:It,activeTexture:jt,bindTexture:_t,unbindTexture:R,compressedTexImage2D:M,compressedTexImage3D:z,texImage2D:Ut,texImage3D:tt,updateUBOMapping:Et,uniformBlockBinding:pt,texStorage2D:lt,texStorage3D:Rt,texSubImage2D:j,texSubImage3D:J,compressedTexSubImage2D:Y,compressedTexSubImage3D:Mt,scissor:at,viewport:vt,reset:Ht}}function _x(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new zt,u=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(R,M){return p?new OffscreenCanvas(R,M):Qr("canvas")}function v(R,M,z){let j=1;const J=_t(R);if((J.width>z||J.height>z)&&(j=z/Math.max(J.width,J.height)),j<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const Y=Math.floor(j*J.width),Mt=Math.floor(j*J.height);h===void 0&&(h=g(Y,Mt));const lt=M?g(Y,Mt):h;return lt.width=Y,lt.height=Mt,lt.getContext("2d").drawImage(R,0,0,Y,Mt),Gt("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+Y+"x"+Mt+")."),lt}else return"data"in R&&Gt("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),R;return R}function m(R){return R.generateMipmaps}function f(R){i.generateMipmap(R)}function x(R){return R.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?i.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(R,M,z,j,J=!1){if(R!==null){if(i[R]!==void 0)return i[R];Gt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let Y=M;if(M===i.RED&&(z===i.FLOAT&&(Y=i.R32F),z===i.HALF_FLOAT&&(Y=i.R16F),z===i.UNSIGNED_BYTE&&(Y=i.R8)),M===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(Y=i.R8UI),z===i.UNSIGNED_SHORT&&(Y=i.R16UI),z===i.UNSIGNED_INT&&(Y=i.R32UI),z===i.BYTE&&(Y=i.R8I),z===i.SHORT&&(Y=i.R16I),z===i.INT&&(Y=i.R32I)),M===i.RG&&(z===i.FLOAT&&(Y=i.RG32F),z===i.HALF_FLOAT&&(Y=i.RG16F),z===i.UNSIGNED_BYTE&&(Y=i.RG8)),M===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(Y=i.RG8UI),z===i.UNSIGNED_SHORT&&(Y=i.RG16UI),z===i.UNSIGNED_INT&&(Y=i.RG32UI),z===i.BYTE&&(Y=i.RG8I),z===i.SHORT&&(Y=i.RG16I),z===i.INT&&(Y=i.RG32I)),M===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),z===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),z===i.UNSIGNED_INT&&(Y=i.RGB32UI),z===i.BYTE&&(Y=i.RGB8I),z===i.SHORT&&(Y=i.RGB16I),z===i.INT&&(Y=i.RGB32I)),M===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),z===i.UNSIGNED_INT&&(Y=i.RGBA32UI),z===i.BYTE&&(Y=i.RGBA8I),z===i.SHORT&&(Y=i.RGBA16I),z===i.INT&&(Y=i.RGBA32I)),M===i.RGB&&(z===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),z===i.UNSIGNED_INT_10F_11F_11F_REV&&(Y=i.R11F_G11F_B10F)),M===i.RGBA){const Mt=J?Jr:ne.getTransfer(j);z===i.FLOAT&&(Y=i.RGBA32F),z===i.HALF_FLOAT&&(Y=i.RGBA16F),z===i.UNSIGNED_BYTE&&(Y=Mt===le?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function S(R,M){let z;return R?M===null||M===Ln||M===Zs?z=i.DEPTH24_STENCIL8:M===gn?z=i.DEPTH32F_STENCIL8:M===Ks&&(z=i.DEPTH24_STENCIL8,Gt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Ln||M===Zs?z=i.DEPTH_COMPONENT24:M===gn?z=i.DEPTH_COMPONENT32F:M===Ks&&(z=i.DEPTH_COMPONENT16),z}function w(R,M){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==Ne&&R.minFilter!==Re?Math.log2(Math.max(M.width,M.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?M.mipmaps.length:1}function b(R){const M=R.target;M.removeEventListener("dispose",b),_(M),M.isVideoTexture&&u.delete(M)}function T(R){const M=R.target;M.removeEventListener("dispose",T),I(M)}function _(R){const M=n.get(R);if(M.__webglInit===void 0)return;const z=R.source,j=d.get(z);if(j){const J=j[M.__cacheKey];J.usedTimes--,J.usedTimes===0&&y(R),Object.keys(j).length===0&&d.delete(z)}n.remove(R)}function y(R){const M=n.get(R);i.deleteTexture(M.__webglTexture);const z=R.source,j=d.get(z);delete j[M.__cacheKey],a.memory.textures--}function I(R){const M=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(M.__webglFramebuffer[j]))for(let J=0;J<M.__webglFramebuffer[j].length;J++)i.deleteFramebuffer(M.__webglFramebuffer[j][J]);else i.deleteFramebuffer(M.__webglFramebuffer[j]);M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer[j])}else{if(Array.isArray(M.__webglFramebuffer))for(let j=0;j<M.__webglFramebuffer.length;j++)i.deleteFramebuffer(M.__webglFramebuffer[j]);else i.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&i.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&i.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let j=0;j<M.__webglColorRenderbuffer.length;j++)M.__webglColorRenderbuffer[j]&&i.deleteRenderbuffer(M.__webglColorRenderbuffer[j]);M.__webglDepthRenderbuffer&&i.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=R.textures;for(let j=0,J=z.length;j<J;j++){const Y=n.get(z[j]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),a.memory.textures--),n.remove(z[j])}n.remove(R)}let C=0;function P(){C=0}function L(){const R=C;return R>=s.maxTextures&&Gt("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+s.maxTextures),C+=1,R}function B(R){const M=[];return M.push(R.wrapS),M.push(R.wrapT),M.push(R.wrapR||0),M.push(R.magFilter),M.push(R.minFilter),M.push(R.anisotropy),M.push(R.internalFormat),M.push(R.format),M.push(R.type),M.push(R.generateMipmaps),M.push(R.premultiplyAlpha),M.push(R.flipY),M.push(R.unpackAlignment),M.push(R.colorSpace),M.join()}function N(R,M){const z=n.get(R);if(R.isVideoTexture&&It(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&z.__version!==R.version){const j=R.image;if(j===null)Gt("WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)Gt("WebGLRenderer: Texture marked for update but image is incomplete");else{K(z,R,M);return}}else R.isExternalTexture&&(z.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+M)}function F(R,M){const z=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&z.__version!==R.version){K(z,R,M);return}else R.isExternalTexture&&(z.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+M)}function H(R,M){const z=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&z.__version!==R.version){K(z,R,M);return}e.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+M)}function Z(R,M){const z=n.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&z.__version!==R.version){rt(z,R,M);return}e.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+M)}const $={[Li]:i.REPEAT,[zn]:i.CLAMP_TO_EDGE,[wo]:i.MIRRORED_REPEAT},Q={[Ne]:i.NEAREST,[Of]:i.NEAREST_MIPMAP_NEAREST,[or]:i.NEAREST_MIPMAP_LINEAR,[Re]:i.LINEAR,[ba]:i.LINEAR_MIPMAP_NEAREST,[bi]:i.LINEAR_MIPMAP_LINEAR},ct={[Gf]:i.NEVER,[Xf]:i.ALWAYS,[Hf]:i.LESS,[Lc]:i.LEQUAL,[kf]:i.EQUAL,[Dc]:i.GEQUAL,[Vf]:i.GREATER,[Wf]:i.NOTEQUAL};function st(R,M){if(M.type===gn&&t.has("OES_texture_float_linear")===!1&&(M.magFilter===Re||M.magFilter===ba||M.magFilter===or||M.magFilter===bi||M.minFilter===Re||M.minFilter===ba||M.minFilter===or||M.minFilter===bi)&&Gt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(R,i.TEXTURE_WRAP_S,$[M.wrapS]),i.texParameteri(R,i.TEXTURE_WRAP_T,$[M.wrapT]),(R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY)&&i.texParameteri(R,i.TEXTURE_WRAP_R,$[M.wrapR]),i.texParameteri(R,i.TEXTURE_MAG_FILTER,Q[M.magFilter]),i.texParameteri(R,i.TEXTURE_MIN_FILTER,Q[M.minFilter]),M.compareFunction&&(i.texParameteri(R,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(R,i.TEXTURE_COMPARE_FUNC,ct[M.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Ne||M.minFilter!==or&&M.minFilter!==bi||M.type===gn&&t.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const z=t.get("EXT_texture_filter_anisotropic");i.texParameterf(R,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function Pt(R,M){let z=!1;R.__webglInit===void 0&&(R.__webglInit=!0,M.addEventListener("dispose",b));const j=M.source;let J=d.get(j);J===void 0&&(J={},d.set(j,J));const Y=B(M);if(Y!==R.__cacheKey){J[Y]===void 0&&(J[Y]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,z=!0),J[Y].usedTimes++;const Mt=J[R.__cacheKey];Mt!==void 0&&(J[R.__cacheKey].usedTimes--,Mt.usedTimes===0&&y(M)),R.__cacheKey=Y,R.__webglTexture=J[Y].texture}return z}function $t(R,M,z){return Math.floor(Math.floor(R/z)/M)}function ie(R,M,z,j){const Y=R.updateRanges;if(Y.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,M.width,M.height,z,j,M.data);else{Y.sort((tt,at)=>tt.start-at.start);let Mt=0;for(let tt=1;tt<Y.length;tt++){const at=Y[Mt],vt=Y[tt],Et=at.start+at.count,pt=$t(vt.start,M.width,4),Ht=$t(at.start,M.width,4);vt.start<=Et+1&&pt===Ht&&$t(vt.start+vt.count-1,M.width,4)===pt?at.count=Math.max(at.count,vt.start+vt.count-at.start):(++Mt,Y[Mt]=vt)}Y.length=Mt+1;const lt=i.getParameter(i.UNPACK_ROW_LENGTH),Rt=i.getParameter(i.UNPACK_SKIP_PIXELS),Ut=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,M.width);for(let tt=0,at=Y.length;tt<at;tt++){const vt=Y[tt],Et=Math.floor(vt.start/4),pt=Math.ceil(vt.count/4),Ht=Et%M.width,O=Math.floor(Et/M.width),ut=pt,ot=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ht),i.pixelStorei(i.UNPACK_SKIP_ROWS,O),e.texSubImage2D(i.TEXTURE_2D,0,Ht,O,ut,ot,z,j,M.data)}R.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,lt),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Rt),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ut)}}function K(R,M,z){let j=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(j=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(j=i.TEXTURE_3D);const J=Pt(R,M),Y=M.source;e.bindTexture(j,R.__webglTexture,i.TEXTURE0+z);const Mt=n.get(Y);if(Y.version!==Mt.__version||J===!0){e.activeTexture(i.TEXTURE0+z);const lt=ne.getPrimaries(ne.workingColorSpace),Rt=M.colorSpace===Bn?null:ne.getPrimaries(M.colorSpace),Ut=M.colorSpace===Bn||lt===Rt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ut);let tt=v(M.image,!1,s.maxTextureSize);tt=jt(M,tt);const at=r.convert(M.format,M.colorSpace),vt=r.convert(M.type);let Et=E(M.internalFormat,at,vt,M.colorSpace,M.isVideoTexture);st(j,M);let pt;const Ht=M.mipmaps,O=M.isVideoTexture!==!0,ut=Mt.__version===void 0||J===!0,ot=Y.dataReady,mt=w(M,tt);if(M.isDepthTexture)Et=S(M.format===Ai,M.type),ut&&(O?e.texStorage2D(i.TEXTURE_2D,1,Et,tt.width,tt.height):e.texImage2D(i.TEXTURE_2D,0,Et,tt.width,tt.height,0,at,vt,null));else if(M.isDataTexture)if(Ht.length>0){O&&ut&&e.texStorage2D(i.TEXTURE_2D,mt,Et,Ht[0].width,Ht[0].height);for(let et=0,X=Ht.length;et<X;et++)pt=Ht[et],O?ot&&e.texSubImage2D(i.TEXTURE_2D,et,0,0,pt.width,pt.height,at,vt,pt.data):e.texImage2D(i.TEXTURE_2D,et,Et,pt.width,pt.height,0,at,vt,pt.data);M.generateMipmaps=!1}else O?(ut&&e.texStorage2D(i.TEXTURE_2D,mt,Et,tt.width,tt.height),ot&&ie(M,tt,at,vt)):e.texImage2D(i.TEXTURE_2D,0,Et,tt.width,tt.height,0,at,vt,tt.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){O&&ut&&e.texStorage3D(i.TEXTURE_2D_ARRAY,mt,Et,Ht[0].width,Ht[0].height,tt.depth);for(let et=0,X=Ht.length;et<X;et++)if(pt=Ht[et],M.format!==cn)if(at!==null)if(O){if(ot)if(M.layerUpdates.size>0){const St=Bl(pt.width,pt.height,M.format,M.type);for(const q of M.layerUpdates){const it=pt.data.subarray(q*St/pt.data.BYTES_PER_ELEMENT,(q+1)*St/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,et,0,0,q,pt.width,pt.height,1,at,it)}M.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,et,0,0,0,pt.width,pt.height,tt.depth,at,pt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,et,Et,pt.width,pt.height,tt.depth,0,pt.data,0,0);else Gt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else O?ot&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,et,0,0,0,pt.width,pt.height,tt.depth,at,vt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,et,Et,pt.width,pt.height,tt.depth,0,at,vt,pt.data)}else{O&&ut&&e.texStorage2D(i.TEXTURE_2D,mt,Et,Ht[0].width,Ht[0].height);for(let et=0,X=Ht.length;et<X;et++)pt=Ht[et],M.format!==cn?at!==null?O?ot&&e.compressedTexSubImage2D(i.TEXTURE_2D,et,0,0,pt.width,pt.height,at,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,et,Et,pt.width,pt.height,0,pt.data):Gt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):O?ot&&e.texSubImage2D(i.TEXTURE_2D,et,0,0,pt.width,pt.height,at,vt,pt.data):e.texImage2D(i.TEXTURE_2D,et,Et,pt.width,pt.height,0,at,vt,pt.data)}else if(M.isDataArrayTexture)if(O){if(ut&&e.texStorage3D(i.TEXTURE_2D_ARRAY,mt,Et,tt.width,tt.height,tt.depth),ot)if(M.layerUpdates.size>0){const et=Bl(tt.width,tt.height,M.format,M.type);for(const X of M.layerUpdates){const St=tt.data.subarray(X*et/tt.data.BYTES_PER_ELEMENT,(X+1)*et/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,X,tt.width,tt.height,1,at,vt,St)}M.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,at,vt,tt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Et,tt.width,tt.height,tt.depth,0,at,vt,tt.data);else if(M.isData3DTexture)O?(ut&&e.texStorage3D(i.TEXTURE_3D,mt,Et,tt.width,tt.height,tt.depth),ot&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,at,vt,tt.data)):e.texImage3D(i.TEXTURE_3D,0,Et,tt.width,tt.height,tt.depth,0,at,vt,tt.data);else if(M.isFramebufferTexture){if(ut)if(O)e.texStorage2D(i.TEXTURE_2D,mt,Et,tt.width,tt.height);else{let et=tt.width,X=tt.height;for(let St=0;St<mt;St++)e.texImage2D(i.TEXTURE_2D,St,Et,et,X,0,at,vt,null),et>>=1,X>>=1}}else if(Ht.length>0){if(O&&ut){const et=_t(Ht[0]);e.texStorage2D(i.TEXTURE_2D,mt,Et,et.width,et.height)}for(let et=0,X=Ht.length;et<X;et++)pt=Ht[et],O?ot&&e.texSubImage2D(i.TEXTURE_2D,et,0,0,at,vt,pt):e.texImage2D(i.TEXTURE_2D,et,Et,at,vt,pt);M.generateMipmaps=!1}else if(O){if(ut){const et=_t(tt);e.texStorage2D(i.TEXTURE_2D,mt,Et,et.width,et.height)}ot&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,at,vt,tt)}else e.texImage2D(i.TEXTURE_2D,0,Et,at,vt,tt);m(M)&&f(j),Mt.__version=Y.version,M.onUpdate&&M.onUpdate(M)}R.__version=M.version}function rt(R,M,z){if(M.image.length!==6)return;const j=Pt(R,M),J=M.source;e.bindTexture(i.TEXTURE_CUBE_MAP,R.__webglTexture,i.TEXTURE0+z);const Y=n.get(J);if(J.version!==Y.__version||j===!0){e.activeTexture(i.TEXTURE0+z);const Mt=ne.getPrimaries(ne.workingColorSpace),lt=M.colorSpace===Bn?null:ne.getPrimaries(M.colorSpace),Rt=M.colorSpace===Bn||Mt===lt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Rt);const Ut=M.isCompressedTexture||M.image[0].isCompressedTexture,tt=M.image[0]&&M.image[0].isDataTexture,at=[];for(let X=0;X<6;X++)!Ut&&!tt?at[X]=v(M.image[X],!0,s.maxCubemapSize):at[X]=tt?M.image[X].image:M.image[X],at[X]=jt(M,at[X]);const vt=at[0],Et=r.convert(M.format,M.colorSpace),pt=r.convert(M.type),Ht=E(M.internalFormat,Et,pt,M.colorSpace),O=M.isVideoTexture!==!0,ut=Y.__version===void 0||j===!0,ot=J.dataReady;let mt=w(M,vt);st(i.TEXTURE_CUBE_MAP,M);let et;if(Ut){O&&ut&&e.texStorage2D(i.TEXTURE_CUBE_MAP,mt,Ht,vt.width,vt.height);for(let X=0;X<6;X++){et=at[X].mipmaps;for(let St=0;St<et.length;St++){const q=et[St];M.format!==cn?Et!==null?O?ot&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,St,0,0,q.width,q.height,Et,q.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,St,Ht,q.width,q.height,0,q.data):Gt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?ot&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,St,0,0,q.width,q.height,Et,pt,q.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,St,Ht,q.width,q.height,0,Et,pt,q.data)}}}else{if(et=M.mipmaps,O&&ut){et.length>0&&mt++;const X=_t(at[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,mt,Ht,X.width,X.height)}for(let X=0;X<6;X++)if(tt){O?ot&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,at[X].width,at[X].height,Et,pt,at[X].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,Ht,at[X].width,at[X].height,0,Et,pt,at[X].data);for(let St=0;St<et.length;St++){const it=et[St].image[X].image;O?ot&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,St+1,0,0,it.width,it.height,Et,pt,it.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,St+1,Ht,it.width,it.height,0,Et,pt,it.data)}}else{O?ot&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,Et,pt,at[X]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,Ht,Et,pt,at[X]);for(let St=0;St<et.length;St++){const q=et[St];O?ot&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,St+1,0,0,Et,pt,q.image[X]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,St+1,Ht,Et,pt,q.image[X])}}}m(M)&&f(i.TEXTURE_CUBE_MAP),Y.__version=J.version,M.onUpdate&&M.onUpdate(M)}R.__version=M.version}function nt(R,M,z,j,J,Y){const Mt=r.convert(z.format,z.colorSpace),lt=r.convert(z.type),Rt=E(z.internalFormat,Mt,lt,z.colorSpace),Ut=n.get(M),tt=n.get(z);if(tt.__renderTarget=M,!Ut.__hasExternalTextures){const at=Math.max(1,M.width>>Y),vt=Math.max(1,M.height>>Y);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,Y,Rt,at,vt,M.depth,0,Mt,lt,null):e.texImage2D(J,Y,Rt,at,vt,0,Mt,lt,null)}e.bindFramebuffer(i.FRAMEBUFFER,R),Qt(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,J,tt.__webglTexture,0,D(M)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,j,J,tt.__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Ot(R,M,z){if(i.bindRenderbuffer(i.RENDERBUFFER,R),M.depthBuffer){const j=M.depthTexture,J=j&&j.isDepthTexture?j.type:null,Y=S(M.stencilBuffer,J),Mt=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Qt(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,D(M),Y,M.width,M.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,D(M),Y,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,Y,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Mt,i.RENDERBUFFER,R)}else{const j=M.textures;for(let J=0;J<j.length;J++){const Y=j[J],Mt=r.convert(Y.format,Y.colorSpace),lt=r.convert(Y.type),Rt=E(Y.internalFormat,Mt,lt,Y.colorSpace);Qt(M)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,D(M),Rt,M.width,M.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,D(M),Rt,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,Rt,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function At(R,M,z){const j=M.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,R),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const J=n.get(M.depthTexture);if(J.__renderTarget=M,(!J.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),j){if(J.__webglInit===void 0&&(J.__webglInit=!0,M.depthTexture.addEventListener("dispose",b)),J.__webglTexture===void 0){J.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),st(i.TEXTURE_CUBE_MAP,M.depthTexture);const Ut=r.convert(M.depthTexture.format),tt=r.convert(M.depthTexture.type);let at;M.depthTexture.format===Yn?at=i.DEPTH_COMPONENT24:M.depthTexture.format===Ai&&(at=i.DEPTH24_STENCIL8);for(let vt=0;vt<6;vt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,at,M.width,M.height,0,Ut,tt,null)}}else N(M.depthTexture,0);const Y=J.__webglTexture,Mt=D(M),lt=j?i.TEXTURE_CUBE_MAP_POSITIVE_X+z:i.TEXTURE_2D,Rt=M.depthTexture.format===Ai?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(M.depthTexture.format===Yn)Qt(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Rt,lt,Y,0,Mt):i.framebufferTexture2D(i.FRAMEBUFFER,Rt,lt,Y,0);else if(M.depthTexture.format===Ai)Qt(M)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Rt,lt,Y,0,Mt):i.framebufferTexture2D(i.FRAMEBUFFER,Rt,lt,Y,0);else throw new Error("Unknown depthTexture format")}function Lt(R){const M=n.get(R),z=R.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==R.depthTexture){const j=R.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),j){const J=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,j.removeEventListener("dispose",J)};j.addEventListener("dispose",J),M.__depthDisposeCallback=J}M.__boundDepthTexture=j}if(R.depthTexture&&!M.__autoAllocateDepthBuffer)if(z)for(let j=0;j<6;j++)At(M.__webglFramebuffer[j],R,j);else{const j=R.texture.mipmaps;j&&j.length>0?At(M.__webglFramebuffer[0],R,0):At(M.__webglFramebuffer,R,0)}else if(z){M.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(e.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[j]),M.__webglDepthbuffer[j]===void 0)M.__webglDepthbuffer[j]=i.createRenderbuffer(),Ot(M.__webglDepthbuffer[j],R,!1);else{const J=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=M.__webglDepthbuffer[j];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,Y)}}else{const j=R.texture.mipmaps;if(j&&j.length>0?e.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=i.createRenderbuffer(),Ot(M.__webglDepthbuffer,R,!1);else{const J=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=M.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,Y)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function ae(R,M,z){const j=n.get(R);M!==void 0&&nt(j.__webglFramebuffer,R,R.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&Lt(R)}function Yt(R){const M=R.texture,z=n.get(R),j=n.get(M);R.addEventListener("dispose",T);const J=R.textures,Y=R.isWebGLCubeRenderTarget===!0,Mt=J.length>1;if(Mt||(j.__webglTexture===void 0&&(j.__webglTexture=i.createTexture()),j.__version=M.version,a.memory.textures++),Y){z.__webglFramebuffer=[];for(let lt=0;lt<6;lt++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[lt]=[];for(let Rt=0;Rt<M.mipmaps.length;Rt++)z.__webglFramebuffer[lt][Rt]=i.createFramebuffer()}else z.__webglFramebuffer[lt]=i.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let lt=0;lt<M.mipmaps.length;lt++)z.__webglFramebuffer[lt]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(Mt)for(let lt=0,Rt=J.length;lt<Rt;lt++){const Ut=n.get(J[lt]);Ut.__webglTexture===void 0&&(Ut.__webglTexture=i.createTexture(),a.memory.textures++)}if(R.samples>0&&Qt(R)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let lt=0;lt<J.length;lt++){const Rt=J[lt];z.__webglColorRenderbuffer[lt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[lt]);const Ut=r.convert(Rt.format,Rt.colorSpace),tt=r.convert(Rt.type),at=E(Rt.internalFormat,Ut,tt,Rt.colorSpace,R.isXRRenderTarget===!0),vt=D(R);i.renderbufferStorageMultisample(i.RENDERBUFFER,vt,at,R.width,R.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+lt,i.RENDERBUFFER,z.__webglColorRenderbuffer[lt])}i.bindRenderbuffer(i.RENDERBUFFER,null),R.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),Ot(z.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),st(i.TEXTURE_CUBE_MAP,M);for(let lt=0;lt<6;lt++)if(M.mipmaps&&M.mipmaps.length>0)for(let Rt=0;Rt<M.mipmaps.length;Rt++)nt(z.__webglFramebuffer[lt][Rt],R,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+lt,Rt);else nt(z.__webglFramebuffer[lt],R,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+lt,0);m(M)&&f(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Mt){for(let lt=0,Rt=J.length;lt<Rt;lt++){const Ut=J[lt],tt=n.get(Ut);let at=i.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(at=R.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(at,tt.__webglTexture),st(at,Ut),nt(z.__webglFramebuffer,R,Ut,i.COLOR_ATTACHMENT0+lt,at,0),m(Ut)&&f(at)}e.unbindTexture()}else{let lt=i.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(lt=R.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(lt,j.__webglTexture),st(lt,M),M.mipmaps&&M.mipmaps.length>0)for(let Rt=0;Rt<M.mipmaps.length;Rt++)nt(z.__webglFramebuffer[Rt],R,M,i.COLOR_ATTACHMENT0,lt,Rt);else nt(z.__webglFramebuffer,R,M,i.COLOR_ATTACHMENT0,lt,0);m(M)&&f(lt),e.unbindTexture()}R.depthBuffer&&Lt(R)}function Kt(R){const M=R.textures;for(let z=0,j=M.length;z<j;z++){const J=M[z];if(m(J)){const Y=x(R),Mt=n.get(J).__webglTexture;e.bindTexture(Y,Mt),f(Y),e.unbindTexture()}}}const se=[],gt=[];function Zt(R){if(R.samples>0){if(Qt(R)===!1){const M=R.textures,z=R.width,j=R.height;let J=i.COLOR_BUFFER_BIT;const Y=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Mt=n.get(R),lt=M.length>1;if(lt)for(let Ut=0;Ut<M.length;Ut++)e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ut,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ut,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer);const Rt=R.texture.mipmaps;Rt&&Rt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Mt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Mt.__webglFramebuffer);for(let Ut=0;Ut<M.length;Ut++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),lt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Mt.__webglColorRenderbuffer[Ut]);const tt=n.get(M[Ut]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,tt,0)}i.blitFramebuffer(0,0,z,j,0,0,z,j,J,i.NEAREST),c===!0&&(se.length=0,gt.length=0,se.push(i.COLOR_ATTACHMENT0+Ut),R.depthBuffer&&R.resolveDepthBuffer===!1&&(se.push(Y),gt.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,gt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,se))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),lt)for(let Ut=0;Ut<M.length;Ut++){e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ut,i.RENDERBUFFER,Mt.__webglColorRenderbuffer[Ut]);const tt=n.get(M[Ut]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ut,i.TEXTURE_2D,tt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&c){const M=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[M])}}}function D(R){return Math.min(s.maxSamples,R.samples)}function Qt(R){const M=n.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function It(R){const M=a.render.frame;u.get(R)!==M&&(u.set(R,M),R.update())}function jt(R,M){const z=R.colorSpace,j=R.format,J=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||z!==_s&&z!==Bn&&(ne.getTransfer(z)===le?(j!==cn||J!==nn)&&Gt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ee("WebGLTextures: Unsupported texture color space:",z)),M}function _t(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(l.width=R.naturalWidth||R.width,l.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(l.width=R.displayWidth,l.height=R.displayHeight):(l.width=R.width,l.height=R.height),l}this.allocateTextureUnit=L,this.resetTextureUnits=P,this.setTexture2D=N,this.setTexture2DArray=F,this.setTexture3D=H,this.setTextureCube=Z,this.rebindTextures=ae,this.setupRenderTarget=Yt,this.updateRenderTargetMipmap=Kt,this.updateMultisampleRenderTarget=Zt,this.setupDepthRenderbuffer=Lt,this.setupFrameBufferTexture=nt,this.useMultisampledRTT=Qt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function xx(i,t){function e(n,s=Bn){let r;const a=ne.getTransfer(s);if(n===nn)return i.UNSIGNED_BYTE;if(n===Ac)return i.UNSIGNED_SHORT_4_4_4_4;if(n===wc)return i.UNSIGNED_SHORT_5_5_5_1;if(n===ad)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===od)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===sd)return i.BYTE;if(n===rd)return i.SHORT;if(n===Ks)return i.UNSIGNED_SHORT;if(n===bc)return i.INT;if(n===Ln)return i.UNSIGNED_INT;if(n===gn)return i.FLOAT;if(n===Xn)return i.HALF_FLOAT;if(n===cd)return i.ALPHA;if(n===ld)return i.RGB;if(n===cn)return i.RGBA;if(n===Yn)return i.DEPTH_COMPONENT;if(n===Ai)return i.DEPTH_STENCIL;if(n===Tc)return i.RED;if(n===Rc)return i.RED_INTEGER;if(n===gs)return i.RG;if(n===Cc)return i.RG_INTEGER;if(n===Pc)return i.RGBA_INTEGER;if(n===kr||n===Vr||n===Wr||n===Xr)if(a===le)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===kr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Vr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Xr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===kr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Vr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Xr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===To||n===Ro||n===Co||n===Po)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===To)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ro)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Co)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Po)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Lo||n===Do||n===Io||n===Uo||n===No||n===Fo||n===Oo)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Lo||n===Do)return a===le?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Io)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Uo)return r.COMPRESSED_R11_EAC;if(n===No)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Fo)return r.COMPRESSED_RG11_EAC;if(n===Oo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Bo||n===zo||n===Go||n===Ho||n===ko||n===Vo||n===Wo||n===Xo||n===Yo||n===qo||n===$o||n===Ko||n===Zo||n===jo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Bo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===zo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Go)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ho)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ko)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Vo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Wo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Xo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Yo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===qo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===$o)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ko)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Zo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===jo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Jo||n===Qo||n===tc)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Jo)return a===le?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Qo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===tc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ec||n===nc||n===ic||n===sc)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===ec)return r.COMPRESSED_RED_RGTC1_EXT;if(n===nc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ic)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===sc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Zs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const vx=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class Sx{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const n=new Sd(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new _n({vertexShader:vx,fragmentShader:Mx,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Ft(new As(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Ex extends ys{constructor(t,e){super();const n=this;let s=null,r=1,a=null,o="local-floor",c=1,l=null,u=null,h=null,d=null,p=null,g=null;const v=typeof XRWebGLBinding<"u",m=new Sx,f={},x=e.getContextAttributes();let E=null,S=null;const w=[],b=[],T=new zt;let _=null;const y=new en;y.viewport=new _e;const I=new en;I.viewport=new _e;const C=[y,I],P=new Ip;let L=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let rt=w[K];return rt===void 0&&(rt=new Da,w[K]=rt),rt.getTargetRaySpace()},this.getControllerGrip=function(K){let rt=w[K];return rt===void 0&&(rt=new Da,w[K]=rt),rt.getGripSpace()},this.getHand=function(K){let rt=w[K];return rt===void 0&&(rt=new Da,w[K]=rt),rt.getHandSpace()};function N(K){const rt=b.indexOf(K.inputSource);if(rt===-1)return;const nt=w[rt];nt!==void 0&&(nt.update(K.inputSource,K.frame,l||a),nt.dispatchEvent({type:K.type,data:K.inputSource}))}function F(){s.removeEventListener("select",N),s.removeEventListener("selectstart",N),s.removeEventListener("selectend",N),s.removeEventListener("squeeze",N),s.removeEventListener("squeezestart",N),s.removeEventListener("squeezeend",N),s.removeEventListener("end",F),s.removeEventListener("inputsourceschange",H);for(let K=0;K<w.length;K++){const rt=b[K];rt!==null&&(b[K]=null,w[K].disconnect(rt))}L=null,B=null,m.reset();for(const K in f)delete f[K];t.setRenderTarget(E),p=null,d=null,h=null,s=null,S=null,ie.stop(),n.isPresenting=!1,t.setPixelRatio(_),t.setSize(T.width,T.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){r=K,n.isPresenting===!0&&Gt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&Gt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(K){l=K},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return h===null&&v&&(h=new XRWebGLBinding(s,e)),h},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(E=t.getRenderTarget(),s.addEventListener("select",N),s.addEventListener("selectstart",N),s.addEventListener("selectend",N),s.addEventListener("squeeze",N),s.addEventListener("squeezestart",N),s.addEventListener("squeezeend",N),s.addEventListener("end",F),s.addEventListener("inputsourceschange",H),x.xrCompatible!==!0&&await e.makeXRCompatible(),_=t.getPixelRatio(),t.getSize(T),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let nt=null,Ot=null,At=null;x.depth&&(At=x.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,nt=x.stencil?Ai:Yn,Ot=x.stencil?Zs:Ln);const Lt={colorFormat:e.RGBA8,depthFormat:At,scaleFactor:r};h=this.getBinding(),d=h.createProjectionLayer(Lt),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),S=new Cn(d.textureWidth,d.textureHeight,{format:cn,type:nn,depthTexture:new Js(d.textureWidth,d.textureHeight,Ot,void 0,void 0,void 0,void 0,void 0,void 0,nt),stencilBuffer:x.stencil,colorSpace:t.outputColorSpace,samples:x.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const nt={antialias:x.antialias,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,nt),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Cn(p.framebufferWidth,p.framebufferHeight,{format:cn,type:nn,colorSpace:t.outputColorSpace,stencilBuffer:x.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await s.requestReferenceSpace(o),ie.setContext(s),ie.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function H(K){for(let rt=0;rt<K.removed.length;rt++){const nt=K.removed[rt],Ot=b.indexOf(nt);Ot>=0&&(b[Ot]=null,w[Ot].disconnect(nt))}for(let rt=0;rt<K.added.length;rt++){const nt=K.added[rt];let Ot=b.indexOf(nt);if(Ot===-1){for(let Lt=0;Lt<w.length;Lt++)if(Lt>=b.length){b.push(nt),Ot=Lt;break}else if(b[Lt]===null){b[Lt]=nt,Ot=Lt;break}if(Ot===-1)break}const At=w[Ot];At&&At.connect(nt)}}const Z=new U,$=new U;function Q(K,rt,nt){Z.setFromMatrixPosition(rt.matrixWorld),$.setFromMatrixPosition(nt.matrixWorld);const Ot=Z.distanceTo($),At=rt.projectionMatrix.elements,Lt=nt.projectionMatrix.elements,ae=At[14]/(At[10]-1),Yt=At[14]/(At[10]+1),Kt=(At[9]+1)/At[5],se=(At[9]-1)/At[5],gt=(At[8]-1)/At[0],Zt=(Lt[8]+1)/Lt[0],D=ae*gt,Qt=ae*Zt,It=Ot/(-gt+Zt),jt=It*-gt;if(rt.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(jt),K.translateZ(It),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),At[10]===-1)K.projectionMatrix.copy(rt.projectionMatrix),K.projectionMatrixInverse.copy(rt.projectionMatrixInverse);else{const _t=ae+It,R=Yt+It,M=D-jt,z=Qt+(Ot-jt),j=Kt*Yt/R*_t,J=se*Yt/R*_t;K.projectionMatrix.makePerspective(M,z,j,J,_t,R),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ct(K,rt){rt===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(rt.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let rt=K.near,nt=K.far;m.texture!==null&&(m.depthNear>0&&(rt=m.depthNear),m.depthFar>0&&(nt=m.depthFar)),P.near=I.near=y.near=rt,P.far=I.far=y.far=nt,(L!==P.near||B!==P.far)&&(s.updateRenderState({depthNear:P.near,depthFar:P.far}),L=P.near,B=P.far),P.layers.mask=K.layers.mask|6,y.layers.mask=P.layers.mask&-5,I.layers.mask=P.layers.mask&-3;const Ot=K.parent,At=P.cameras;ct(P,Ot);for(let Lt=0;Lt<At.length;Lt++)ct(At[Lt],Ot);At.length===2?Q(P,y,I):P.projectionMatrix.copy(y.projectionMatrix),st(K,P,Ot)};function st(K,rt,nt){nt===null?K.matrix.copy(rt.matrixWorld):(K.matrix.copy(nt.matrixWorld),K.matrix.invert(),K.matrix.multiply(rt.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(rt.projectionMatrix),K.projectionMatrixInverse.copy(rt.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=ac*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return P},this.getFoveation=function(){if(!(d===null&&p===null))return c},this.setFoveation=function(K){c=K,d!==null&&(d.fixedFoveation=K),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(P)},this.getCameraTexture=function(K){return f[K]};let Pt=null;function $t(K,rt){if(u=rt.getViewerPose(l||a),g=rt,u!==null){const nt=u.views;p!==null&&(t.setRenderTargetFramebuffer(S,p.framebuffer),t.setRenderTarget(S));let Ot=!1;nt.length!==P.cameras.length&&(P.cameras.length=0,Ot=!0);for(let Yt=0;Yt<nt.length;Yt++){const Kt=nt[Yt];let se=null;if(p!==null)se=p.getViewport(Kt);else{const Zt=h.getViewSubImage(d,Kt);se=Zt.viewport,Yt===0&&(t.setRenderTargetTextures(S,Zt.colorTexture,Zt.depthStencilTexture),t.setRenderTarget(S))}let gt=C[Yt];gt===void 0&&(gt=new en,gt.layers.enable(Yt),gt.viewport=new _e,C[Yt]=gt),gt.matrix.fromArray(Kt.transform.matrix),gt.matrix.decompose(gt.position,gt.quaternion,gt.scale),gt.projectionMatrix.fromArray(Kt.projectionMatrix),gt.projectionMatrixInverse.copy(gt.projectionMatrix).invert(),gt.viewport.set(se.x,se.y,se.width,se.height),Yt===0&&(P.matrix.copy(gt.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale)),Ot===!0&&P.cameras.push(gt)}const At=s.enabledFeatures;if(At&&At.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&v){h=n.getBinding();const Yt=h.getDepthInformation(nt[0]);Yt&&Yt.isValid&&Yt.texture&&m.init(Yt,s.renderState)}if(At&&At.includes("camera-access")&&v){t.state.unbindTexture(),h=n.getBinding();for(let Yt=0;Yt<nt.length;Yt++){const Kt=nt[Yt].camera;if(Kt){let se=f[Kt];se||(se=new Sd,f[Kt]=se);const gt=h.getCameraImage(Kt);se.sourceTexture=gt}}}}for(let nt=0;nt<w.length;nt++){const Ot=b[nt],At=w[nt];Ot!==null&&At!==void 0&&At.update(Ot,rt,l||a)}Pt&&Pt(K,rt),rt.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:rt}),g=null}const ie=new Ad;ie.setAnimationLoop($t),this.setAnimationLoop=function(K){Pt=K},this.dispose=function(){}}}const xi=new ke,yx=new te;function bx(i,t){function e(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,Ed(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,x,E,S){f.isMeshBasicMaterial?r(m,f):f.isMeshLambertMaterial?(r(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(r(m,f),h(m,f)):f.isMeshPhongMaterial?(r(m,f),u(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(r(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,S)):f.isMeshMatcapMaterial?(r(m,f),g(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),v(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?c(m,f,x,E):f.isSpriteMaterial?l(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,e(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Ge&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,e(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Ge&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,e(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,e(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const x=t.get(f),E=x.envMap,S=x.envMapRotation;E&&(m.envMap.value=E,xi.copy(S),xi.x*=-1,xi.y*=-1,xi.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(xi.y*=-1,xi.z*=-1),m.envMapRotation.value.setFromMatrix4(yx.makeRotationFromEuler(xi)),m.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function c(m,f,x,E){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*x,m.scale.value=E*.5,f.map&&(m.map.value=f.map,e(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function l(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function u(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function h(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,x){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Ge&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=x.texture,m.transmissionSamplerSize.value.set(x.width,x.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function v(m,f){const x=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(x.matrixWorld),m.nearDistance.value=x.shadow.camera.near,m.farDistance.value=x.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Ax(i,t,e,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(x,E){const S=E.program;n.uniformBlockBinding(x,S)}function l(x,E){let S=s[x.id];S===void 0&&(g(x),S=u(x),s[x.id]=S,x.addEventListener("dispose",m));const w=E.program;n.updateUBOMapping(x,w);const b=t.render.frame;r[x.id]!==b&&(d(x),r[x.id]=b)}function u(x){const E=h();x.__bindingPointIndex=E;const S=i.createBuffer(),w=x.__size,b=x.usage;return i.bindBuffer(i.UNIFORM_BUFFER,S),i.bufferData(i.UNIFORM_BUFFER,w,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,S),S}function h(){for(let x=0;x<o;x++)if(a.indexOf(x)===-1)return a.push(x),x;return ee("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(x){const E=s[x.id],S=x.uniforms,w=x.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let b=0,T=S.length;b<T;b++){const _=Array.isArray(S[b])?S[b]:[S[b]];for(let y=0,I=_.length;y<I;y++){const C=_[y];if(p(C,b,y,w)===!0){const P=C.__offset,L=Array.isArray(C.value)?C.value:[C.value];let B=0;for(let N=0;N<L.length;N++){const F=L[N],H=v(F);typeof F=="number"||typeof F=="boolean"?(C.__data[0]=F,i.bufferSubData(i.UNIFORM_BUFFER,P+B,C.__data)):F.isMatrix3?(C.__data[0]=F.elements[0],C.__data[1]=F.elements[1],C.__data[2]=F.elements[2],C.__data[3]=0,C.__data[4]=F.elements[3],C.__data[5]=F.elements[4],C.__data[6]=F.elements[5],C.__data[7]=0,C.__data[8]=F.elements[6],C.__data[9]=F.elements[7],C.__data[10]=F.elements[8],C.__data[11]=0):(F.toArray(C.__data,B),B+=H.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,P,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(x,E,S,w){const b=x.value,T=E+"_"+S;if(w[T]===void 0)return typeof b=="number"||typeof b=="boolean"?w[T]=b:w[T]=b.clone(),!0;{const _=w[T];if(typeof b=="number"||typeof b=="boolean"){if(_!==b)return w[T]=b,!0}else if(_.equals(b)===!1)return _.copy(b),!0}return!1}function g(x){const E=x.uniforms;let S=0;const w=16;for(let T=0,_=E.length;T<_;T++){const y=Array.isArray(E[T])?E[T]:[E[T]];for(let I=0,C=y.length;I<C;I++){const P=y[I],L=Array.isArray(P.value)?P.value:[P.value];for(let B=0,N=L.length;B<N;B++){const F=L[B],H=v(F),Z=S%w,$=Z%H.boundary,Q=Z+$;S+=$,Q!==0&&w-Q<H.storage&&(S+=w-Q),P.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),P.__offset=S,S+=H.storage}}}const b=S%w;return b>0&&(S+=w-b),x.__size=S,x.__cache={},this}function v(x){const E={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(E.boundary=4,E.storage=4):x.isVector2?(E.boundary=8,E.storage=8):x.isVector3||x.isColor?(E.boundary=16,E.storage=12):x.isVector4?(E.boundary=16,E.storage=16):x.isMatrix3?(E.boundary=48,E.storage=48):x.isMatrix4?(E.boundary=64,E.storage=64):x.isTexture?Gt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Gt("WebGLRenderer: Unsupported uniform value type.",x),E}function m(x){const E=x.target;E.removeEventListener("dispose",m);const S=a.indexOf(E.__bindingPointIndex);a.splice(S,1),i.deleteBuffer(s[E.id]),delete s[E.id],delete r[E.id]}function f(){for(const x in s)i.deleteBuffer(s[x]);a=[],s={},r={}}return{bind:c,update:l,dispose:f}}const wx=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let yn=null;function Tx(){return yn===null&&(yn=new Oc(wx,16,16,gs,Xn),yn.name="DFG_LUT",yn.minFilter=Re,yn.magFilter=Re,yn.wrapS=zn,yn.wrapT=zn,yn.generateMipmaps=!1,yn.needsUpdate=!0),yn}class Rx{constructor(t={}){const{canvas:e=qf(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:d=!1,outputBufferType:p=nn}=t;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;const v=p,m=new Set([Pc,Cc,Rc]),f=new Set([nn,Ln,Ks,Zs,Ac,wc]),x=new Uint32Array(4),E=new Int32Array(4);let S=null,w=null;const b=[],T=[];let _=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Rn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let I=!1;this._outputColorSpace=Ue;let C=0,P=0,L=null,B=-1,N=null;const F=new _e,H=new _e;let Z=null;const $=new Bt(0);let Q=0,ct=e.width,st=e.height,Pt=1,$t=null,ie=null;const K=new _e(0,0,ct,st),rt=new _e(0,0,ct,st);let nt=!1;const Ot=new Bc;let At=!1,Lt=!1;const ae=new te,Yt=new U,Kt=new _e,se={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let gt=!1;function Zt(){return L===null?Pt:1}let D=n;function Qt(A,G){return e.getContext(A,G)}try{const A={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Ec}`),e.addEventListener("webglcontextlost",St,!1),e.addEventListener("webglcontextrestored",q,!1),e.addEventListener("webglcontextcreationerror",it,!1),D===null){const G="webgl2";if(D=Qt(G,A),D===null)throw Qt(G)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw ee("WebGLRenderer: "+A.message),A}let It,jt,_t,R,M,z,j,J,Y,Mt,lt,Rt,Ut,tt,at,vt,Et,pt,Ht,O,ut,ot,mt;function et(){It=new Rg(D),It.init(),ut=new xx(D,It),jt=new Mg(D,It,t,ut),_t=new gx(D,It),jt.reversedDepthBuffer&&d&&_t.buffers.depth.setReversed(!0),R=new Lg(D),M=new nx,z=new _x(D,It,_t,M,jt,ut,R),j=new Tg(y),J=new Fp(D),ot=new xg(D,J),Y=new Cg(D,J,R,ot),Mt=new Ig(D,Y,J,ot,R),pt=new Dg(D,jt,z),at=new Sg(M),lt=new ex(y,j,It,jt,ot,at),Rt=new bx(y,M),Ut=new sx,tt=new ux(It),Et=new _g(y,j,_t,Mt,g,c),vt=new mx(y,Mt,jt),mt=new Ax(D,R,jt,_t),Ht=new vg(D,It,R),O=new Pg(D,It,R),R.programs=lt.programs,y.capabilities=jt,y.extensions=It,y.properties=M,y.renderLists=Ut,y.shadowMap=vt,y.state=_t,y.info=R}et(),v!==nn&&(_=new Ng(v,e.width,e.height,s,r));const X=new Ex(y,D);this.xr=X,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const A=It.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=It.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return Pt},this.setPixelRatio=function(A){A!==void 0&&(Pt=A,this.setSize(ct,st,!1))},this.getSize=function(A){return A.set(ct,st)},this.setSize=function(A,G,W=!0){if(X.isPresenting){Gt("WebGLRenderer: Can't change size while VR device is presenting.");return}ct=A,st=G,e.width=Math.floor(A*Pt),e.height=Math.floor(G*Pt),W===!0&&(e.style.width=A+"px",e.style.height=G+"px"),_!==null&&_.setSize(e.width,e.height),this.setViewport(0,0,A,G)},this.getDrawingBufferSize=function(A){return A.set(ct*Pt,st*Pt).floor()},this.setDrawingBufferSize=function(A,G,W){ct=A,st=G,Pt=W,e.width=Math.floor(A*W),e.height=Math.floor(G*W),this.setViewport(0,0,A,G)},this.setEffects=function(A){if(v===nn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let G=0;G<A.length;G++)if(A[G].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}_.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(F)},this.getViewport=function(A){return A.copy(K)},this.setViewport=function(A,G,W,V){A.isVector4?K.set(A.x,A.y,A.z,A.w):K.set(A,G,W,V),_t.viewport(F.copy(K).multiplyScalar(Pt).round())},this.getScissor=function(A){return A.copy(rt)},this.setScissor=function(A,G,W,V){A.isVector4?rt.set(A.x,A.y,A.z,A.w):rt.set(A,G,W,V),_t.scissor(H.copy(rt).multiplyScalar(Pt).round())},this.getScissorTest=function(){return nt},this.setScissorTest=function(A){_t.setScissorTest(nt=A)},this.setOpaqueSort=function(A){$t=A},this.setTransparentSort=function(A){ie=A},this.getClearColor=function(A){return A.copy(Et.getClearColor())},this.setClearColor=function(){Et.setClearColor(...arguments)},this.getClearAlpha=function(){return Et.getClearAlpha()},this.setClearAlpha=function(){Et.setClearAlpha(...arguments)},this.clear=function(A=!0,G=!0,W=!0){let V=0;if(A){let k=!1;if(L!==null){const ht=L.texture.format;k=m.has(ht)}if(k){const ht=L.texture.type,xt=f.has(ht),ft=Et.getClearColor(),yt=Et.getClearAlpha(),Tt=ft.r,kt=ft.g,qt=ft.b;xt?(x[0]=Tt,x[1]=kt,x[2]=qt,x[3]=yt,D.clearBufferuiv(D.COLOR,0,x)):(E[0]=Tt,E[1]=kt,E[2]=qt,E[3]=yt,D.clearBufferiv(D.COLOR,0,E))}else V|=D.COLOR_BUFFER_BIT}G&&(V|=D.DEPTH_BUFFER_BIT),W&&(V|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V!==0&&D.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",St,!1),e.removeEventListener("webglcontextrestored",q,!1),e.removeEventListener("webglcontextcreationerror",it,!1),Et.dispose(),Ut.dispose(),tt.dispose(),M.dispose(),j.dispose(),Mt.dispose(),ot.dispose(),mt.dispose(),lt.dispose(),X.dispose(),X.removeEventListener("sessionstart",Xe),X.removeEventListener("sessionend",Le),De.stop()};function St(A){A.preventDefault(),ta("WebGLRenderer: Context Lost."),I=!0}function q(){ta("WebGLRenderer: Context Restored."),I=!1;const A=R.autoReset,G=vt.enabled,W=vt.autoUpdate,V=vt.needsUpdate,k=vt.type;et(),R.autoReset=A,vt.enabled=G,vt.autoUpdate=W,vt.needsUpdate=V,vt.type=k}function it(A){ee("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function wt(A){const G=A.target;G.removeEventListener("dispose",wt),Nt(G)}function Nt(A){me(A),M.remove(A)}function me(A){const G=M.get(A).programs;G!==void 0&&(G.forEach(function(W){lt.releaseProgram(W)}),A.isShaderMaterial&&lt.releaseShaderCache(A))}this.renderBufferDirect=function(A,G,W,V,k,ht){G===null&&(G=se);const xt=k.isMesh&&k.matrixWorld.determinant()<0,ft=Ts(A,G,W,V,k);_t.setMaterial(V,xt);let yt=W.index,Tt=1;if(V.wireframe===!0){if(yt=Y.getWireframeAttribute(W),yt===void 0)return;Tt=2}const kt=W.drawRange,qt=W.attributes.position;let Ct=kt.start*Tt,de=(kt.start+kt.count)*Tt;ht!==null&&(Ct=Math.max(Ct,ht.start*Tt),de=Math.min(de,(ht.start+ht.count)*Tt)),yt!==null?(Ct=Math.max(Ct,0),de=Math.min(de,yt.count)):qt!=null&&(Ct=Math.max(Ct,0),de=Math.min(de,qt.count));const xe=de-Ct;if(xe<0||xe===1/0)return;ot.setup(k,V,ft,W,yt);let ge,he=Ht;if(yt!==null&&(ge=J.get(yt),he=O,he.setIndex(ge)),k.isMesh)V.wireframe===!0?(_t.setLineWidth(V.wireframeLinewidth*Zt()),he.setMode(D.LINES)):he.setMode(D.TRIANGLES);else if(k.isLine){let Oe=V.linewidth;Oe===void 0&&(Oe=1),_t.setLineWidth(Oe*Zt()),k.isLineSegments?he.setMode(D.LINES):k.isLineLoop?he.setMode(D.LINE_LOOP):he.setMode(D.LINE_STRIP)}else k.isPoints?he.setMode(D.POINTS):k.isSprite&&he.setMode(D.TRIANGLES);if(k.isBatchedMesh)if(k._multiDrawInstances!==null)ea("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),he.renderMultiDrawInstances(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount,k._multiDrawInstances);else if(It.get("WEBGL_multi_draw"))he.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{const Oe=k._multiDrawStarts,bt=k._multiDrawCounts,je=k._multiDrawCount,re=yt?J.get(yt).bytesPerElement:1,dn=M.get(V).currentProgram.getUniforms();for(let Sn=0;Sn<je;Sn++)dn.setValue(D,"_gl_DrawID",Sn),he.render(Oe[Sn]/re,bt[Sn])}else if(k.isInstancedMesh)he.renderInstances(Ct,xe,k.count);else if(W.isInstancedBufferGeometry){const Oe=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,bt=Math.min(W.instanceCount,Oe);he.renderInstances(Ct,xe,bt)}else he.render(Ct,xe)};function Pe(A,G,W){A.transparent===!0&&A.side===An&&A.forceSinglePass===!1?(A.side=Ge,A.needsUpdate=!0,Mn(A,G,W),A.side=li,A.needsUpdate=!0,Mn(A,G,W),A.side=An):Mn(A,G,W)}this.compile=function(A,G,W=null){W===null&&(W=A),w=tt.get(W),w.init(G),T.push(w),W.traverseVisible(function(k){k.isLight&&k.layers.test(G.layers)&&(w.pushLight(k),k.castShadow&&w.pushShadow(k))}),A!==W&&A.traverseVisible(function(k){k.isLight&&k.layers.test(G.layers)&&(w.pushLight(k),k.castShadow&&w.pushShadow(k))}),w.setupLights();const V=new Set;return A.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;const ht=k.material;if(ht)if(Array.isArray(ht))for(let xt=0;xt<ht.length;xt++){const ft=ht[xt];Pe(ft,W,k),V.add(ft)}else Pe(ht,W,k),V.add(ht)}),w=T.pop(),V},this.compileAsync=function(A,G,W=null){const V=this.compile(A,G,W);return new Promise(k=>{function ht(){if(V.forEach(function(xt){M.get(xt).currentProgram.isReady()&&V.delete(xt)}),V.size===0){k(A);return}setTimeout(ht,10)}It.get("KHR_parallel_shader_compile")!==null?ht():setTimeout(ht,10)})};let We=null;function xn(A){We&&We(A)}function Xe(){De.stop()}function Le(){De.start()}const De=new Ad;De.setAnimationLoop(xn),typeof self<"u"&&De.setContext(self),this.setAnimationLoop=function(A){We=A,X.setAnimationLoop(A),A===null?De.stop():De.start()},X.addEventListener("sessionstart",Xe),X.addEventListener("sessionend",Le),this.render=function(A,G){if(G!==void 0&&G.isCamera!==!0){ee("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;const W=X.enabled===!0&&X.isPresenting===!0,V=_!==null&&(L===null||W)&&_.begin(y,L);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),G.parent===null&&G.matrixWorldAutoUpdate===!0&&G.updateMatrixWorld(),X.enabled===!0&&X.isPresenting===!0&&(_===null||_.isCompositing()===!1)&&(X.cameraAutoUpdate===!0&&X.updateCamera(G),G=X.getCamera()),A.isScene===!0&&A.onBeforeRender(y,A,G,L),w=tt.get(A,T.length),w.init(G),T.push(w),ae.multiplyMatrices(G.projectionMatrix,G.matrixWorldInverse),Ot.setFromProjectionMatrix(ae,Tn,G.reversedDepth),Lt=this.localClippingEnabled,At=at.init(this.clippingPlanes,Lt),S=Ut.get(A,b.length),S.init(),b.push(S),X.enabled===!0&&X.isPresenting===!0){const xt=y.xr.getDepthSensingMesh();xt!==null&&Ze(xt,G,-1/0,y.sortObjects)}Ze(A,G,0,y.sortObjects),S.finish(),y.sortObjects===!0&&S.sort($t,ie),gt=X.enabled===!1||X.isPresenting===!1||X.hasDepthSensing()===!1,gt&&Et.addToRenderList(S,A),this.info.render.frame++,At===!0&&at.beginShadows();const k=w.state.shadowsArray;if(vt.render(k,A,G),At===!0&&at.endShadows(),this.info.autoReset===!0&&this.info.reset(),(V&&_.hasRenderPass())===!1){const xt=S.opaque,ft=S.transmissive;if(w.setupLights(),G.isArrayCamera){const yt=G.cameras;if(ft.length>0)for(let Tt=0,kt=yt.length;Tt<kt;Tt++){const qt=yt[Tt];un(xt,ft,A,qt)}gt&&Et.render(A);for(let Tt=0,kt=yt.length;Tt<kt;Tt++){const qt=yt[Tt];sn(S,A,qt,qt.viewport)}}else ft.length>0&&un(xt,ft,A,G),gt&&Et.render(A),sn(S,A,G)}L!==null&&P===0&&(z.updateMultisampleRenderTarget(L),z.updateRenderTargetMipmap(L)),V&&_.end(y),A.isScene===!0&&A.onAfterRender(y,A,G),ot.resetDefaultState(),B=-1,N=null,T.pop(),T.length>0?(w=T[T.length-1],At===!0&&at.setGlobalState(y.clippingPlanes,w.state.camera)):w=null,b.pop(),b.length>0?S=b[b.length-1]:S=null};function Ze(A,G,W,V){if(A.visible===!1)return;if(A.layers.test(G.layers)){if(A.isGroup)W=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(G);else if(A.isLight)w.pushLight(A),A.castShadow&&w.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Ot.intersectsSprite(A)){V&&Kt.setFromMatrixPosition(A.matrixWorld).applyMatrix4(ae);const xt=Mt.update(A),ft=A.material;ft.visible&&S.push(A,xt,ft,W,Kt.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Ot.intersectsObject(A))){const xt=Mt.update(A),ft=A.material;if(V&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),Kt.copy(A.boundingSphere.center)):(xt.boundingSphere===null&&xt.computeBoundingSphere(),Kt.copy(xt.boundingSphere.center)),Kt.applyMatrix4(A.matrixWorld).applyMatrix4(ae)),Array.isArray(ft)){const yt=xt.groups;for(let Tt=0,kt=yt.length;Tt<kt;Tt++){const qt=yt[Tt],Ct=ft[qt.materialIndex];Ct&&Ct.visible&&S.push(A,xt,Ct,W,Kt.z,qt)}}else ft.visible&&S.push(A,xt,ft,W,Kt.z,null)}}const ht=A.children;for(let xt=0,ft=ht.length;xt<ft;xt++)Ze(ht[xt],G,W,V)}function sn(A,G,W,V){const{opaque:k,transmissive:ht,transparent:xt}=A;w.setupLightsView(W),At===!0&&at.setGlobalState(y.clippingPlanes,W),V&&_t.viewport(F.copy(V)),k.length>0&&vn(k,G,W),ht.length>0&&vn(ht,G,W),xt.length>0&&vn(xt,G,W),_t.buffers.depth.setTest(!0),_t.buffers.depth.setMask(!0),_t.buffers.color.setMask(!0),_t.setPolygonOffset(!1)}function un(A,G,W,V){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[V.id]===void 0){const Ct=It.has("EXT_color_buffer_half_float")||It.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[V.id]=new Cn(1,1,{generateMipmaps:!0,type:Ct?Xn:nn,minFilter:bi,samples:Math.max(4,jt.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ne.workingColorSpace})}const ht=w.state.transmissionRenderTarget[V.id],xt=V.viewport||F;ht.setSize(xt.z*y.transmissionResolutionScale,xt.w*y.transmissionResolutionScale);const ft=y.getRenderTarget(),yt=y.getActiveCubeFace(),Tt=y.getActiveMipmapLevel();y.setRenderTarget(ht),y.getClearColor($),Q=y.getClearAlpha(),Q<1&&y.setClearColor(16777215,.5),y.clear(),gt&&Et.render(W);const kt=y.toneMapping;y.toneMapping=Rn;const qt=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),w.setupLightsView(V),At===!0&&at.setGlobalState(y.clippingPlanes,V),vn(A,W,V),z.updateMultisampleRenderTarget(ht),z.updateRenderTargetMipmap(ht),It.has("WEBGL_multisampled_render_to_texture")===!1){let Ct=!1;for(let de=0,xe=G.length;de<xe;de++){const ge=G[de],{object:he,geometry:Oe,material:bt,group:je}=ge;if(bt.side===An&&he.layers.test(V.layers)){const re=bt.side;bt.side=Ge,bt.needsUpdate=!0,$e(he,W,V,Oe,bt,je),bt.side=re,bt.needsUpdate=!0,Ct=!0}}Ct===!0&&(z.updateMultisampleRenderTarget(ht),z.updateRenderTargetMipmap(ht))}y.setRenderTarget(ft,yt,Tt),y.setClearColor($,Q),qt!==void 0&&(V.viewport=qt),y.toneMapping=kt}function vn(A,G,W){const V=G.isScene===!0?G.overrideMaterial:null;for(let k=0,ht=A.length;k<ht;k++){const xt=A[k],{object:ft,geometry:yt,group:Tt}=xt;let kt=xt.material;kt.allowOverride===!0&&V!==null&&(kt=V),ft.layers.test(W.layers)&&$e(ft,G,W,yt,kt,Tt)}}function $e(A,G,W,V,k,ht){A.onBeforeRender(y,G,W,V,k,ht),A.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),k.onBeforeRender(y,G,W,V,A,ht),k.transparent===!0&&k.side===An&&k.forceSinglePass===!1?(k.side=Ge,k.needsUpdate=!0,y.renderBufferDirect(W,G,V,k,A,ht),k.side=li,k.needsUpdate=!0,y.renderBufferDirect(W,G,V,k,A,ht),k.side=An):y.renderBufferDirect(W,G,V,k,A,ht),A.onAfterRender(y,G,W,V,k,ht)}function Mn(A,G,W){G.isScene!==!0&&(G=se);const V=M.get(A),k=w.state.lights,ht=w.state.shadowsArray,xt=k.state.version,ft=lt.getParameters(A,k.state,ht,G,W),yt=lt.getProgramCacheKey(ft);let Tt=V.programs;V.environment=A.isMeshStandardMaterial||A.isMeshLambertMaterial||A.isMeshPhongMaterial?G.environment:null,V.fog=G.fog;const kt=A.isMeshStandardMaterial||A.isMeshLambertMaterial&&!A.envMap||A.isMeshPhongMaterial&&!A.envMap;V.envMap=j.get(A.envMap||V.environment,kt),V.envMapRotation=V.environment!==null&&A.envMap===null?G.environmentRotation:A.envMapRotation,Tt===void 0&&(A.addEventListener("dispose",wt),Tt=new Map,V.programs=Tt);let qt=Tt.get(yt);if(qt!==void 0){if(V.currentProgram===qt&&V.lightsStateVersion===xt)return Oi(A,ft),qt}else ft.uniforms=lt.getUniforms(A),A.onBeforeCompile(ft,y),qt=lt.acquireProgram(ft,yt),Tt.set(yt,qt),V.uniforms=ft.uniforms;const Ct=V.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Ct.clippingPlanes=at.uniform),Oi(A,ft),V.needsLights=Vd(A),V.lightsStateVersion=xt,V.needsLights&&(Ct.ambientLightColor.value=k.state.ambient,Ct.lightProbe.value=k.state.probe,Ct.directionalLights.value=k.state.directional,Ct.directionalLightShadows.value=k.state.directionalShadow,Ct.spotLights.value=k.state.spot,Ct.spotLightShadows.value=k.state.spotShadow,Ct.rectAreaLights.value=k.state.rectArea,Ct.ltc_1.value=k.state.rectAreaLTC1,Ct.ltc_2.value=k.state.rectAreaLTC2,Ct.pointLights.value=k.state.point,Ct.pointLightShadows.value=k.state.pointShadow,Ct.hemisphereLights.value=k.state.hemi,Ct.directionalShadowMatrix.value=k.state.directionalShadowMatrix,Ct.spotLightMatrix.value=k.state.spotLightMatrix,Ct.spotLightMap.value=k.state.spotLightMap,Ct.pointShadowMatrix.value=k.state.pointShadowMatrix),V.currentProgram=qt,V.uniformsList=null,qt}function Dn(A){if(A.uniformsList===null){const G=A.currentProgram.getUniforms();A.uniformsList=Yr.seqWithValue(G.seq,A.uniforms)}return A.uniformsList}function Oi(A,G){const W=M.get(A);W.outputColorSpace=G.outputColorSpace,W.batching=G.batching,W.batchingColor=G.batchingColor,W.instancing=G.instancing,W.instancingColor=G.instancingColor,W.instancingMorph=G.instancingMorph,W.skinning=G.skinning,W.morphTargets=G.morphTargets,W.morphNormals=G.morphNormals,W.morphColors=G.morphColors,W.morphTargetsCount=G.morphTargetsCount,W.numClippingPlanes=G.numClippingPlanes,W.numIntersection=G.numClipIntersection,W.vertexAlphas=G.vertexAlphas,W.vertexTangents=G.vertexTangents,W.toneMapping=G.toneMapping}function Ts(A,G,W,V,k){G.isScene!==!0&&(G=se),z.resetTextureUnits();const ht=G.fog,xt=V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial?G.environment:null,ft=L===null?y.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:_s,yt=V.isMeshStandardMaterial||V.isMeshLambertMaterial&&!V.envMap||V.isMeshPhongMaterial&&!V.envMap,Tt=j.get(V.envMap||xt,yt),kt=V.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,qt=!!W.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Ct=!!W.morphAttributes.position,de=!!W.morphAttributes.normal,xe=!!W.morphAttributes.color;let ge=Rn;V.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(ge=y.toneMapping);const he=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Oe=he!==void 0?he.length:0,bt=M.get(V),je=w.state.lights;if(At===!0&&(Lt===!0||A!==N)){const we=A===N&&V.id===B;at.setState(V,A,we)}let re=!1;V.version===bt.__version?(bt.needsLights&&bt.lightsStateVersion!==je.state.version||bt.outputColorSpace!==ft||k.isBatchedMesh&&bt.batching===!1||!k.isBatchedMesh&&bt.batching===!0||k.isBatchedMesh&&bt.batchingColor===!0&&k.colorTexture===null||k.isBatchedMesh&&bt.batchingColor===!1&&k.colorTexture!==null||k.isInstancedMesh&&bt.instancing===!1||!k.isInstancedMesh&&bt.instancing===!0||k.isSkinnedMesh&&bt.skinning===!1||!k.isSkinnedMesh&&bt.skinning===!0||k.isInstancedMesh&&bt.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&bt.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&bt.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&bt.instancingMorph===!1&&k.morphTexture!==null||bt.envMap!==Tt||V.fog===!0&&bt.fog!==ht||bt.numClippingPlanes!==void 0&&(bt.numClippingPlanes!==at.numPlanes||bt.numIntersection!==at.numIntersection)||bt.vertexAlphas!==kt||bt.vertexTangents!==qt||bt.morphTargets!==Ct||bt.morphNormals!==de||bt.morphColors!==xe||bt.toneMapping!==ge||bt.morphTargetsCount!==Oe)&&(re=!0):(re=!0,bt.__version=V.version);let dn=bt.currentProgram;re===!0&&(dn=Mn(V,G,k));let Sn=!1,hi=!1,Bi=!1;const pe=dn.getUniforms(),Ie=bt.uniforms;if(_t.useProgram(dn.program)&&(Sn=!0,hi=!0,Bi=!0),V.id!==B&&(B=V.id,hi=!0),Sn||N!==A){_t.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),pe.setValue(D,"projectionMatrix",A.projectionMatrix),pe.setValue(D,"viewMatrix",A.matrixWorldInverse);const Zn=pe.map.cameraPosition;Zn!==void 0&&Zn.setValue(D,Yt.setFromMatrixPosition(A.matrixWorld)),jt.logarithmicDepthBuffer&&pe.setValue(D,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&pe.setValue(D,"isOrthographic",A.isOrthographicCamera===!0),N!==A&&(N=A,hi=!0,Bi=!0)}if(bt.needsLights&&(je.state.directionalShadowMap.length>0&&pe.setValue(D,"directionalShadowMap",je.state.directionalShadowMap,z),je.state.spotShadowMap.length>0&&pe.setValue(D,"spotShadowMap",je.state.spotShadowMap,z),je.state.pointShadowMap.length>0&&pe.setValue(D,"pointShadowMap",je.state.pointShadowMap,z)),k.isSkinnedMesh){pe.setOptional(D,k,"bindMatrix"),pe.setOptional(D,k,"bindMatrixInverse");const we=k.skeleton;we&&(we.boneTexture===null&&we.computeBoneTexture(),pe.setValue(D,"boneTexture",we.boneTexture,z))}k.isBatchedMesh&&(pe.setOptional(D,k,"batchingTexture"),pe.setValue(D,"batchingTexture",k._matricesTexture,z),pe.setOptional(D,k,"batchingIdTexture"),pe.setValue(D,"batchingIdTexture",k._indirectTexture,z),pe.setOptional(D,k,"batchingColorTexture"),k._colorsTexture!==null&&pe.setValue(D,"batchingColorTexture",k._colorsTexture,z));const Kn=W.morphAttributes;if((Kn.position!==void 0||Kn.normal!==void 0||Kn.color!==void 0)&&pt.update(k,W,dn),(hi||bt.receiveShadow!==k.receiveShadow)&&(bt.receiveShadow=k.receiveShadow,pe.setValue(D,"receiveShadow",k.receiveShadow)),(V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial)&&V.envMap===null&&G.environment!==null&&(Ie.envMapIntensity.value=G.environmentIntensity),Ie.dfgLUT!==void 0&&(Ie.dfgLUT.value=Tx()),hi&&(pe.setValue(D,"toneMappingExposure",y.toneMappingExposure),bt.needsLights&&Rs(Ie,Bi),ht&&V.fog===!0&&Rt.refreshFogUniforms(Ie,ht),Rt.refreshMaterialUniforms(Ie,V,Pt,st,w.state.transmissionRenderTarget[A.id]),Yr.upload(D,Dn(bt),Ie,z)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Yr.upload(D,Dn(bt),Ie,z),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&pe.setValue(D,"center",k.center),pe.setValue(D,"modelViewMatrix",k.modelViewMatrix),pe.setValue(D,"normalMatrix",k.normalMatrix),pe.setValue(D,"modelMatrix",k.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const we=V.uniformsGroups;for(let Zn=0,zi=we.length;Zn<zi;Zn++){const jc=we[Zn];mt.update(jc,dn),mt.bind(jc,dn)}}return dn}function Rs(A,G){A.ambientLightColor.needsUpdate=G,A.lightProbe.needsUpdate=G,A.directionalLights.needsUpdate=G,A.directionalLightShadows.needsUpdate=G,A.pointLights.needsUpdate=G,A.pointLightShadows.needsUpdate=G,A.spotLights.needsUpdate=G,A.spotLightShadows.needsUpdate=G,A.rectAreaLights.needsUpdate=G,A.hemisphereLights.needsUpdate=G}function Vd(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(A,G,W){const V=M.get(A);V.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),M.get(A.texture).__webglTexture=G,M.get(A.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:W,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,G){const W=M.get(A);W.__webglFramebuffer=G,W.__useDefaultFramebuffer=G===void 0};const Wd=D.createFramebuffer();this.setRenderTarget=function(A,G=0,W=0){L=A,C=G,P=W;let V=null,k=!1,ht=!1;if(A){const ft=M.get(A);if(ft.__useDefaultFramebuffer!==void 0){_t.bindFramebuffer(D.FRAMEBUFFER,ft.__webglFramebuffer),F.copy(A.viewport),H.copy(A.scissor),Z=A.scissorTest,_t.viewport(F),_t.scissor(H),_t.setScissorTest(Z),B=-1;return}else if(ft.__webglFramebuffer===void 0)z.setupRenderTarget(A);else if(ft.__hasExternalTextures)z.rebindTextures(A,M.get(A.texture).__webglTexture,M.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const kt=A.depthTexture;if(ft.__boundDepthTexture!==kt){if(kt!==null&&M.has(kt)&&(A.width!==kt.image.width||A.height!==kt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");z.setupDepthRenderbuffer(A)}}const yt=A.texture;(yt.isData3DTexture||yt.isDataArrayTexture||yt.isCompressedArrayTexture)&&(ht=!0);const Tt=M.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Tt[G])?V=Tt[G][W]:V=Tt[G],k=!0):A.samples>0&&z.useMultisampledRTT(A)===!1?V=M.get(A).__webglMultisampledFramebuffer:Array.isArray(Tt)?V=Tt[W]:V=Tt,F.copy(A.viewport),H.copy(A.scissor),Z=A.scissorTest}else F.copy(K).multiplyScalar(Pt).floor(),H.copy(rt).multiplyScalar(Pt).floor(),Z=nt;if(W!==0&&(V=Wd),_t.bindFramebuffer(D.FRAMEBUFFER,V)&&_t.drawBuffers(A,V),_t.viewport(F),_t.scissor(H),_t.setScissorTest(Z),k){const ft=M.get(A.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+G,ft.__webglTexture,W)}else if(ht){const ft=G;for(let yt=0;yt<A.textures.length;yt++){const Tt=M.get(A.textures[yt]);D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0+yt,Tt.__webglTexture,W,ft)}}else if(A!==null&&W!==0){const ft=M.get(A.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ft.__webglTexture,W)}B=-1},this.readRenderTargetPixels=function(A,G,W,V,k,ht,xt,ft=0){if(!(A&&A.isWebGLRenderTarget)){ee("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let yt=M.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&xt!==void 0&&(yt=yt[xt]),yt){_t.bindFramebuffer(D.FRAMEBUFFER,yt);try{const Tt=A.textures[ft],kt=Tt.format,qt=Tt.type;if(A.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ft),!jt.textureFormatReadable(kt)){ee("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!jt.textureTypeReadable(qt)){ee("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}G>=0&&G<=A.width-V&&W>=0&&W<=A.height-k&&D.readPixels(G,W,V,k,ut.convert(kt),ut.convert(qt),ht)}finally{const Tt=L!==null?M.get(L).__webglFramebuffer:null;_t.bindFramebuffer(D.FRAMEBUFFER,Tt)}}},this.readRenderTargetPixelsAsync=async function(A,G,W,V,k,ht,xt,ft=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let yt=M.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&xt!==void 0&&(yt=yt[xt]),yt)if(G>=0&&G<=A.width-V&&W>=0&&W<=A.height-k){_t.bindFramebuffer(D.FRAMEBUFFER,yt);const Tt=A.textures[ft],kt=Tt.format,qt=Tt.type;if(A.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ft),!jt.textureFormatReadable(kt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!jt.textureTypeReadable(qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ct=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,Ct),D.bufferData(D.PIXEL_PACK_BUFFER,ht.byteLength,D.STREAM_READ),D.readPixels(G,W,V,k,ut.convert(kt),ut.convert(qt),0);const de=L!==null?M.get(L).__webglFramebuffer:null;_t.bindFramebuffer(D.FRAMEBUFFER,de);const xe=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await $f(D,xe,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,Ct),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,ht),D.deleteBuffer(Ct),D.deleteSync(xe),ht}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,G=null,W=0){const V=Math.pow(2,-W),k=Math.floor(A.image.width*V),ht=Math.floor(A.image.height*V),xt=G!==null?G.x:0,ft=G!==null?G.y:0;z.setTexture2D(A,0),D.copyTexSubImage2D(D.TEXTURE_2D,W,0,0,xt,ft,k,ht),_t.unbindTexture()};const Xd=D.createFramebuffer(),Yd=D.createFramebuffer();this.copyTextureToTexture=function(A,G,W=null,V=null,k=0,ht=0){let xt,ft,yt,Tt,kt,qt,Ct,de,xe;const ge=A.isCompressedTexture?A.mipmaps[ht]:A.image;if(W!==null)xt=W.max.x-W.min.x,ft=W.max.y-W.min.y,yt=W.isBox3?W.max.z-W.min.z:1,Tt=W.min.x,kt=W.min.y,qt=W.isBox3?W.min.z:0;else{const Ie=Math.pow(2,-k);xt=Math.floor(ge.width*Ie),ft=Math.floor(ge.height*Ie),A.isDataArrayTexture?yt=ge.depth:A.isData3DTexture?yt=Math.floor(ge.depth*Ie):yt=1,Tt=0,kt=0,qt=0}V!==null?(Ct=V.x,de=V.y,xe=V.z):(Ct=0,de=0,xe=0);const he=ut.convert(G.format),Oe=ut.convert(G.type);let bt;G.isData3DTexture?(z.setTexture3D(G,0),bt=D.TEXTURE_3D):G.isDataArrayTexture||G.isCompressedArrayTexture?(z.setTexture2DArray(G,0),bt=D.TEXTURE_2D_ARRAY):(z.setTexture2D(G,0),bt=D.TEXTURE_2D),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,G.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,G.unpackAlignment);const je=D.getParameter(D.UNPACK_ROW_LENGTH),re=D.getParameter(D.UNPACK_IMAGE_HEIGHT),dn=D.getParameter(D.UNPACK_SKIP_PIXELS),Sn=D.getParameter(D.UNPACK_SKIP_ROWS),hi=D.getParameter(D.UNPACK_SKIP_IMAGES);D.pixelStorei(D.UNPACK_ROW_LENGTH,ge.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,ge.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Tt),D.pixelStorei(D.UNPACK_SKIP_ROWS,kt),D.pixelStorei(D.UNPACK_SKIP_IMAGES,qt);const Bi=A.isDataArrayTexture||A.isData3DTexture,pe=G.isDataArrayTexture||G.isData3DTexture;if(A.isDepthTexture){const Ie=M.get(A),Kn=M.get(G),we=M.get(Ie.__renderTarget),Zn=M.get(Kn.__renderTarget);_t.bindFramebuffer(D.READ_FRAMEBUFFER,we.__webglFramebuffer),_t.bindFramebuffer(D.DRAW_FRAMEBUFFER,Zn.__webglFramebuffer);for(let zi=0;zi<yt;zi++)Bi&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,M.get(A).__webglTexture,k,qt+zi),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,M.get(G).__webglTexture,ht,xe+zi)),D.blitFramebuffer(Tt,kt,xt,ft,Ct,de,xt,ft,D.DEPTH_BUFFER_BIT,D.NEAREST);_t.bindFramebuffer(D.READ_FRAMEBUFFER,null),_t.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(k!==0||A.isRenderTargetTexture||M.has(A)){const Ie=M.get(A),Kn=M.get(G);_t.bindFramebuffer(D.READ_FRAMEBUFFER,Xd),_t.bindFramebuffer(D.DRAW_FRAMEBUFFER,Yd);for(let we=0;we<yt;we++)Bi?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Ie.__webglTexture,k,qt+we):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,Ie.__webglTexture,k),pe?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Kn.__webglTexture,ht,xe+we):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,Kn.__webglTexture,ht),k!==0?D.blitFramebuffer(Tt,kt,xt,ft,Ct,de,xt,ft,D.COLOR_BUFFER_BIT,D.NEAREST):pe?D.copyTexSubImage3D(bt,ht,Ct,de,xe+we,Tt,kt,xt,ft):D.copyTexSubImage2D(bt,ht,Ct,de,Tt,kt,xt,ft);_t.bindFramebuffer(D.READ_FRAMEBUFFER,null),_t.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else pe?A.isDataTexture||A.isData3DTexture?D.texSubImage3D(bt,ht,Ct,de,xe,xt,ft,yt,he,Oe,ge.data):G.isCompressedArrayTexture?D.compressedTexSubImage3D(bt,ht,Ct,de,xe,xt,ft,yt,he,ge.data):D.texSubImage3D(bt,ht,Ct,de,xe,xt,ft,yt,he,Oe,ge):A.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,ht,Ct,de,xt,ft,he,Oe,ge.data):A.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,ht,Ct,de,ge.width,ge.height,he,ge.data):D.texSubImage2D(D.TEXTURE_2D,ht,Ct,de,xt,ft,he,Oe,ge);D.pixelStorei(D.UNPACK_ROW_LENGTH,je),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,re),D.pixelStorei(D.UNPACK_SKIP_PIXELS,dn),D.pixelStorei(D.UNPACK_SKIP_ROWS,Sn),D.pixelStorei(D.UNPACK_SKIP_IMAGES,hi),ht===0&&G.generateMipmaps&&D.generateMipmap(bt),_t.unbindTexture()},this.initRenderTarget=function(A){M.get(A).__webglFramebuffer===void 0&&z.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?z.setTextureCube(A,0):A.isData3DTexture?z.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?z.setTexture2DArray(A,0):z.setTexture2D(A,0),_t.unbindTexture()},this.resetState=function(){C=0,P=0,L=null,_t.reset(),ot.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Tn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=ne._getDrawingBufferColorSpace(t),e.unpackColorSpace=ne._getUnpackColorSpace()}}const $s=4,Yc=80,cu=-.4,Ld=18,Dd=12,Cx=120,Id=6,Px=6,Lx=.5,Dx=2,dc=24,Ix=1,Ux=3;function Di(i,t,e){if(i===t)return e<i?0:1;let n=(e-i)/(t-i);return n<=0?0:n>=1?1:n*n*(3-2*n)}function fs(i,t,e){return e===0?i:e===1?t:i+(t-i)*e}function Nr(i,t,e){let n=(i|0)>>>0;n=(n^(t|0)>>>0)>>>0,n=Math.imul(n^n>>>16,73244475)>>>0,n=(n^(e|0)>>>0)>>>0,n=Math.imul(n^n>>>16,73244475)>>>0,n=n+1831565813>>>0;let s=n;return s=Math.imul(s^s>>>15,s|1)>>>0,s=(s^s+Math.imul(s^s>>>7,s|61))>>>0,s=(s^s>>>14)>>>0,s/4294967296}function lu(i){return Math.floor(i/dc)}function Nx(i,t,e){let n=0,s=1,r=0,a=t,o=e,c=i>>>0;for(let l=0;l<Ux;l++){const u=lu(a),h=lu(o),d=a/dc-u,p=o/dc-h,g=Nr(c,u,h),v=Nr(c,u+1,h),m=Nr(c,u,h+1),f=Nr(c,u+1,h+1),x=d*d*(3-2*d),E=p*p*(3-2*p),S=fs(g,v,x),w=fs(m,f,x),b=fs(S,w,E);n+=(b*2-1)*s,r+=s,s*=.5,a*=2,o*=2,c=Math.imul(c^2654435769,2246822507)>>>0>>>0}return r===0?0:n/r}function Fx(i,t){let e=0;if(i.viaducts)for(const n of i.viaducts)e+=-n.valleyDepth*tr(t,n.center,n.halfLen);if(i.tunnels)for(const n of i.tunnels)e+=n.hillHeight*tr(t,n.center,n.halfLen);return e}function tr(i,t,e){const n=Math.abs(i-t);return n<=e?1:1-Di(e,e+Cx,n)}function ye(i,t){return nr(i,t)}function Ud(i,t,e){return ye(i,t)+Fx(i,t)}function Ox(i,t,e){const n=i.terrainSeed??Ix,s=Nx(n,t,e)*Px;return Ud(i,t)+s}function Nd(i,t){return Ud(i,t)-ye(i,t)}function Bx(i,t){let e=0;if(i.viaducts)for(const n of i.viaducts){const s=n.valleyDepth*tr(t,n.center,n.halfLen);e=Math.max(e,Di(0,Ld,s))}if(i.tunnels)for(const n of i.tunnels){const s=n.hillHeight*tr(t,n.center,n.halfLen);e=Math.max(e,Di(0,Dd,s))}return e}function qn(i,t){return Nd(i,t)<-Ld}function zx(i,t){return Nd(i,t)>Dd}function $n(i,t,e){return zx(i,t)&&Math.abs(e)<Id}function Gx(i){return i<=$s?cu:cu*(1-Di($s,$s+Yc,i))}function Hx(i,t){let e=0;if(i.tunnels)for(const n of i.tunnels)e+=n.hillHeight*tr(t,n.center,n.halfLen);return e}function kx(i,t,e){const n=Hx(i,t);if(n===0)return 0;const s=1-Di($s,Id+Yc,e),r=Di(0,Dx,n);return s*r}function ci(i,t,e){const n=Math.abs(e),s=ye(i,t),r=Ox(i,t,e),a=s+Gx(n),o=Di(0,Yc,n-$s),c=fs(a,r,o),l=Bx(i,t),u=fs(c,r,l),h=kx(i,t,n);return fs(u,a,h)}function Ii(i,t,e,n){return ci(i,t,e)+n}function Vx(i,t,e,n){const s=ci(i,t,e)+Lx;return n>s?n:s}const Wx=1.9,Xx=.5,Yx=.052,qx=.07;function uu(i,t){return i>t?t:i<-t?-t:i}function $x(i,t,e){return{pitch:uu(e*Math.atan(t),Yx),roll:uu(e*i,qx)}}function Kx(i,t,e,n){const s=ue(i,t,e),r=s.y+n;return{x:s.x,y:Vx(i,t,e,r),z:s.z,heading:s.heading}}const Zx=120,jx=240*Math.PI/180,Jx=120*Math.PI/180,du=-.5,hu=.55,Qx=3.2,tv=52*Math.PI/180,fu=-12*Math.PI/180;function ev(i,t=0){const e=new ve;e.position.x=t,i.add(e);const n=new Wc(16771272,.9,3.2);n.position.set(t,.15,-.35),i.add(n);const s=new Dt({color:1316895,roughness:.7,metalness:.3}),r=new Dt({color:1777704,roughness:.6,metalness:.25}),a=new Dt({color:790292,roughness:.8,metalness:.2}),o=1.02,c=.82,l=-1.25,u=-.95,h=.85,d=.05,p=h-u,g=(u+h)/2,v=(c+l)/2,m=c-l,f=(gt,Zt,D,Qt,It,jt)=>{const _t=new Ft(new Wt(gt,Zt,D),a);_t.position.set(Qt,It,jt),e.add(_t)};f(d,m,p,-o,v,g),f(d,m,p,o,v,g),f(2*o+d,d,p,0,c,g),f(2*o+d,d,p,0,l,g),f(2*o+d,m,d,0,v,h);const x=o-.95+d,E=.95+x/2-d/2;f(x,m,d,-E,v,u),f(x,m,d,E,v,u);const S=c-.62;f(2*.95,S,d,0,.62+S/2,u);const w=-.62-l;f(2*.95,w,d,0,-.62-w/2,u);const b=-.9,T=a,_=.95,y=.62,I=.06,C=(gt,Zt,D,Qt)=>{const It=new Ft(new Wt(gt,Zt,I),T);return It.position.set(D,Qt,b),It};e.add(C(2*_+I,I,0,y)),e.add(C(2*_+I,I,0,-y)),e.add(C(I,2*y,-_,0)),e.add(C(I,2*y,_,0)),e.add(C(I,2*y,0,0));const P=new Ft(new Wt(1.9,.08,.55),r);P.position.set(0,-.62,-.78),P.rotation.x=-.18,e.add(P);function L(gt,Zt){const D=new ve;D.position.set(gt,-.58,-.7);const Qt=new Ft(new Pn(.018,.022,.26,12),s);Qt.position.y=.13,D.add(Qt);const It=new Ft(new ln(.04,16,12),new Dt({color:Zt,roughness:.5,metalness:.2}));return It.position.y=.27,D.add(It),e.add(D),D}const B=L(-.42,3828282),N=L(.42,6959152),F=new ve;F.position.set(-.74,-.58,-.66);const H=new Ft(new Pn(.014,.016,.14,10),s);H.position.y=.07,F.add(H),e.add(F);const Z=new ve;Z.position.set(0,-.46,-.66),Z.rotation.x=-.35;const $=new Ft(new Pn(.12,.12,.02,32),new Dt({color:329740,roughness:.5,metalness:.1}));$.rotation.x=Math.PI/2,Z.add($);const Q=new Ft(new kc(.12,.012,12,32),new Dt({color:2238771,roughness:.6,metalness:.4}));Z.add(Q);const ct=new ve;Z.add(ct);const st=new Ft(new Wt(.012,.1,.006),new Dt({color:16733491,emissive:16724753,emissiveIntensity:.6,roughness:.4}));st.position.set(0,.045,.012),ct.add(st);const Pt=new Qs(.03,20);function $t(gt,Zt){const D=new Dt({color:658706,emissive:new Bt(Zt),emissiveIntensity:0,roughness:.5}),Qt=new Ft(Pt,D);return Qt.position.set(gt,-.4,-.64),Qt.rotation.x=-.35,e.add(Qt),{mesh:Qt,mat:D}}const ie=$t(-.36,16756768),K=$t(-.28,16756768),rt=$t(-.2,16724770),nt=new ve;nt.position.set(.34,-.4,-.64),nt.rotation.x=-.35;const Ot=new Ft(new Qs(.035,24),new Dt({color:329482,roughness:.6}));nt.add(Ot);const At=new Ft(new Hc(.018,.034,16,1),new Dt({color:15777824,emissive:12619792,emissiveIntensity:.5,roughness:.5}));At.position.z=.001,At.visible=!1,nt.add(At),e.add(nt);let Lt=0;const ae=new ve;ae.position.set(-.5,-y+.02,b-.04);const Yt=new Ft(new Wt(.025,1.05,.02),new Dt({color:329482,roughness:.8}));Yt.position.y=.5,ae.add(Yt),e.add(ae);function Kt(gt,Zt,D){return gt+(Zt-gt)*D}function se(gt){B.rotation.x=Kt(du,hu,Fr(gt.powerFrac)),N.rotation.x=Kt(du,hu,Fr(gt.brakeFrac)),F.rotation.x=gt.reverser==="FWD"?.5:gt.reverser==="REV"?-.5:0;const Zt=Fr(Math.abs(gt.speedMph)/Zx);if(ct.rotation.z=Jx-Zt*jx,ie.mat.emissiveIntensity=gt.dra?1.1:0,K.mat.emissiveIntensity=gt.dsd?1.1:0,rt.mat.emissiveIntensity=gt.penalty?1.3:0,At.visible=gt.sunflower==="CAUTION",gt.wiperOn)Lt+=gt.dt*Qx,ae.rotation.z=fu+Math.sin(Lt)*tv;else{const D=Fr(gt.dt*4);ae.rotation.z=Kt(ae.rotation.z,fu,D)}}return{update:se}}const Fr=i=>i<0?0:i>1?1:i;function Or(i,t,e){let n=(i|0)*374761393+(t|0)*668265263+(e|0)*362437;return n=(n^n>>>13)*1274126177,n=n^n>>>16,(n>>>0)/4294967296}function ui(i){return i*i*(3-2*i)}function nv(i,t,e,n){const s=Math.floor(i),r=Math.floor(t),a=ui(i-s),o=ui(t-r),c=(s%e+e)%e,l=(r%e+e)%e,u=(c+1)%e,h=(l+1)%e,d=Or(c,l,n),p=Or(u,l,n),g=Or(c,h,n),v=Or(u,h,n),m=d+(p-d)*a,f=g+(v-g)*a;return m+(f-m)*o}function pu(i,t,e,n,s){let r=0,a=1,o=0,c=e,l=1;for(let u=0;u<n;u++)r+=a*nv(i*l,t*l,c,s+u*101),o+=a,a*=.5,l*=2,c*=2;return o>0?r/o:0}function Fd(i){const t=document.createElement("canvas");t.width=i,t.height=i;const e=t.getContext("2d");if(!e){const s=new ImageData(i,i);return{canvas:t,ctx:e,img:s}}const n=e.createImageData(i,i);return{canvas:t,ctx:e,img:n}}function Vn(i){return i<0?0:i>255?255:i|0}function vs(i,t,e){const n=new ir(i);return n.colorSpace=Ue,n.wrapS=Li,n.wrapT=Li,n.repeat.set(t,t),n.anisotropy=e,n.needsUpdate=!0,n}function pa(i,t,e){const n=new ir(i);return n.colorSpace=Bn,n.wrapS=Li,n.wrapT=Li,n.repeat.set(t,t),n.anisotropy=e,n.needsUpdate=!0,n}function ma(i,t,e,n){const{canvas:s,ctx:r,img:a}=Fd(i),o=a.data;for(let c=0;c<i*i;c++){const l=t[c]??0,u=e[c]??0,[h,d,p]=n(l,u),g=c*4;o[g]=Vn(h),o[g+1]=Vn(d),o[g+2]=Vn(p),o[g+3]=255}return r&&typeof r.putImageData=="function"&&r.putImageData(a,0,0),s}function ga(i,t,e){const{canvas:n,ctx:s,img:r}=Fd(i),a=r.data,o=(c,l)=>{const u=(c%i+i)%i,h=(l%i+i)%i;return t[h*i+u]??0};for(let c=0;c<i;c++)for(let l=0;l<i;l++){const u=(o(l-1,c)-o(l+1,c))*e,h=(o(l,c-1)-o(l,c+1))*e,d=-u,p=-h,g=1,v=Math.sqrt(d*d+p*p+g*g)||1,m=(c*i+l)*4;a[m]=Vn(d/v*127.5+127.5),a[m+1]=Vn(p/v*127.5+127.5),a[m+2]=Vn(g/v*127.5+127.5),a[m+3]=255}return s&&typeof s.putImageData=="function"&&s.putImageData(r,0,0),n}function _a(i,t,e,n,s,r){const a=new Float32Array(i*i),o=new Float32Array(i*i),c=t/i,l=n/i;for(let u=0;u<i;u++)for(let h=0;h<i;h++){const d=u*i+h;a[d]=pu(h*c,u*c,t,e,r),o[d]=pu(h*l,u*l,n,s,r+9973)}return{height:a,detail:o}}function di(i,t,e){return[i[0]+(t[0]-i[0])*e,i[1]+(t[1]-i[1])*e,i[2]+(t[2]-i[2])*e]}function iv(i,t,e){const{height:n,detail:s}=_a(i,4,4,16,3,1311),r=[86,66,40],a=[48,70,32],o=[96,122,56],c=ma(i,n,s,(h,d)=>{const p=di(a,o,d);return di(r,p,ui(Math.min(1,h*1.3)))}),l=new Float32Array(i*i);for(let h=0;h<l.length;h++)l[h]=(n[h]??0)*.7+(s[h]??0)*.3;const u=ga(i,l,3);return{albedo:vs(c,t,e),normal:pa(u,t,e)}}function sv(i,t,e){const{height:n,detail:s}=_a(i,8,2,32,4,5101),r=[60,58,56],a=[140,136,130],o=ma(i,n,s,(l,u)=>{const h=ui(u);return di(r,a,h)}),c=ga(i,s,5);return{albedo:vs(o,t,e),normal:pa(c,t,e)}}function rv(i,t,e){const{height:n,detail:s}=_a(i,6,3,24,2,7321),r=[150,146,138],a=[110,104,96],o=new Float32Array(i*i),c=ma(i,n,s,(u,h)=>di(a,r,ui(u*.6+h*.4)));for(let u=0;u<i;u++){const h=Math.abs(u/i*6%1-.5)<.04?0:1;for(let d=0;d<i;d++){const p=u*i+d;o[p]=(s[p]??0)*.5+h*.5}}const l=ga(i,o,2);return{albedo:vs(c,t,e),normal:pa(l,t,e)}}function av(i,t,e){const{height:n,detail:s}=_a(i,2,2,48,2,211),r=[96,98,104],a=[150,152,158],o=new Float32Array(i*i),c=ma(i,n,s,(u,h)=>{const d=ui(h*.6+.2);return di(r,a,d)});for(let u=0;u<o.length;u++)o[u]=(s[u]??0)*.25;const l=ga(i,o,.8);return{albedo:vs(c,t,e),normal:pa(l,t,e)}}function ov(i=4,t=2654435769){let e=t>>>0;const n=()=>{e=e+1831565813>>>0;let E=e;return E=Math.imul(E^E>>>15,E|1),E^=E+Math.imul(E^E>>>7,E|61),((E^E>>>14)>>>0)/4294967296},s=["#ffd9a0","#ffcf86","#ffe6c4","#cfe0ff","#fff4d6","#ffb870"],r=128,a=256,o=document.createElement("canvas");o.width=r,o.height=a;const c=o.getContext("2d"),l=document.createElement("canvas");l.width=r,l.height=a;const u=l.getContext("2d");c.fillStyle="rgb(150,148,142)",c.fillRect(0,0,r,a),u.fillStyle="#000",u.fillRect(0,0,r,a);const h=5,d=13,p=12,g=12,v=(r-p*2)/h,m=(a-g*2)/d,f=v*.5,x=m*.52;for(let E=0;E<=d;E++){const S=Math.round(g+E*m);c.fillStyle="rgba(0,0,0,0.10)",c.fillRect(0,S-1,r,2)}for(let E=0;E<d;E++)for(let S=0;S<h;S++){const w=p+S*v+(v-f)/2,b=g+E*m+(m-x)/2;if(c.fillStyle="rgba(0,0,0,0.35)",c.fillRect(w-1,b-1,f+2,x+2),c.fillStyle="rgb(150,165,185)",c.fillRect(w,b,f,x),n()<.5){const T=s[Math.floor(n()*s.length)];u.fillStyle=T,u.fillRect(w,b,f,x),c.globalAlpha=.5,c.fillStyle=T,c.fillRect(w,b,f,x),c.globalAlpha=1}}return{albedo:vs(o,1,i),emissive:vs(l,1,i)}}function cv(i=1){const t=Math.max(1,i|0),e=iv(256,1,t),n=sv(128,1,t),s=rv(256,1,t),r=av(64,1,t),a=[e,n,s,r];return{ground:e,ballast:n,masonry:s,rail:r,dispose(){for(const o of a)o.albedo.dispose(),o.normal.dispose()}}}const ia=16,sa=16;function mu(i){return[i>>16&255,i>>8&255,i&255]}function gu(i,t){const e=mu(i),n=mu(t),s=[e[0]*.72,e[1]*.76,e[2]*.85],r=di(e,[255,255,255],.18),a=new Uint8Array(ia*sa*4);lv(a,s,r,n);const o=new Oc(a,ia,sa,cn);return o.mapping=Hr,o.colorSpace=Ue,o.minFilter=Re,o.magFilter=Re,o.needsUpdate=!0,o}function lv(i,t,e,n){for(let s=0;s<sa;s++){const r=s/(sa-1);let a;r<.5?a=di(t,e,ui(r/.5)):a=di(e,n,ui((r-.5)/.5));for(let o=0;o<ia;o++){const c=(s*ia+o)*4;i[c]=Vn(a[0]),i[c+1]=Vn(a[1]),i[c+2]=Vn(a[2]),i[c+3]=255}}}function uv(i){i&&i.dispose()}function dv(){const t=document.createElement("canvas");t.width=t.height=32;const e=t.getContext("2d");if(e){const r=e.createRadialGradient(16,16,0,16,16,16);r.addColorStop(0,"rgba(255,255,255,1)"),r.addColorStop(.5,"rgba(255,255,255,0.55)"),r.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=r,e.fillRect(0,0,32,32)}const n=new ir(t);return n.colorSpace=Ue,n.needsUpdate=!0,n}function hv(i){const e=document.createElement("canvas");e.width=e.height=128;const n=e.getContext("2d");if(n){const r=new Bt(i),a=Math.round(r.r*255),o=Math.round(r.g*255),c=Math.round(r.b*255),l=128/2,u=n.createRadialGradient(l,l,0,l,l,l);u.addColorStop(0,`rgba(${a},${o},${c},0.9)`),u.addColorStop(.3,`rgba(${a},${o},${c},0.32)`),u.addColorStop(1,`rgba(${a},${o},${c},0)`),n.fillStyle=u,n.fillRect(0,0,128,128)}const s=new ir(e);return s.colorSpace=Ue,s.needsUpdate=!0,s}function sr(i){let t=i>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}const Ce=new te,Ms=new U,Ss=new U,Es=new Ve,hc=new U(0,1,0);function Wn(i,t,e,n,s,r,a,o){Ce.compose(Ms.set(e,n,s),Es,Ss.set(r,a,o)),i.setMatrixAt(t,Ce)}function fv(i,t,e){gv(i,t,e),_v(i,t,e);const n=xv(i,t,e);return io(i,t,e,1200,5922406),io(i,t,e,3e3,7034695),vv(i,t,4e3),io(i,t,e,6600,7034695),Mv(i,t,e),pv(i,t,e),{buildingMat:n}}function pv(i,t,e){const n=t.length,s=24,r=Math.max(1,Math.floor(n/s)),a=new Dt({color:657930,emissive:16773328,emissiveIntensity:2.2}),o=new oe(new ln(.13,6,6),a,r),c=e/2+1.6;for(let l=0;l<r;l++){const u=(l+1)*s,d=(l%2?1:-1)*c;if(u>n||qn(t,u)||$n(t,u,d)){Wn(o,l,0,-1e3,0,1,1,1);continue}const p=ue(t,u,d);Wn(o,l,p.x,Ii(t,u,d,.4),p.z,1,1,1)}o.instanceMatrix.needsUpdate=!0,o.frustumCulled=!1,i.add(o)}function mv(i,t,e){const a=sr(212126286),o=[{d:-12.7175,dir:1},{d:-17.7175,dir:-1},{d:e/2+14,dir:-1}],c=6,l=[];for(const b of o)for(let T=0;T<c;T++)l.push({s:3950+T/c*650+a()*50,d:b.d,dir:b.dir,speed:9+a()*7});const u=l.length,h=new oe(new Wt(1.9,1.3,4.2),new Dt({color:789776,roughness:.5,metalness:.4}),u),d=new oe(new ln(.2,6,6),new Dt({color:2236962,emissive:16645094,emissiveIntensity:3.2}),u*2),p=new oe(new ln(.16,6,6),new Dt({color:2228224,emissive:16722450,emissiveIntensity:1.8}),u*2);h.frustumCulled=!1,d.frustumCulled=!1,p.frustumCulled=!1,i.add(h,d,p);const g=new U,v=new U,m=new U,f=new Ve,x=new ke(0,0,0,"YXZ"),E=new U(1,1,1),S=(b,T,_,y)=>{m.set(_,0,y).applyQuaternion(f),v.copy(g).add(m),Ce.compose(v,f,E),b.setMatrixAt(T,Ce)};function w(b){for(let T=0;T<u;T++){const _=l[T];if(!_)continue;_.s+=_.dir*_.speed*b,_.s>4600?_.s-=650:_.s<3950&&(_.s+=650);const y=ue(t,_.s,_.d),I=Ii(t,_.s,_.d,0);x.set(0,y.heading+(_.dir>0?0:Math.PI),0),f.setFromEuler(x),g.set(y.x,I+.65,y.z),Ce.compose(g,f,E),h.setMatrixAt(T,Ce),S(d,T*2,-.6,2.05),S(d,T*2+1,.6,2.05),S(p,T*2,-.6,-2.05),S(p,T*2+1,.6,-2.05)}h.instanceMatrix.needsUpdate=!0,d.instanceMatrix.needsUpdate=!0,p.instanceMatrix.needsUpdate=!0}return w(0),{update:w}}function gv(i,t,e){const n=t.length,s=sr(8675309),r=720,a=new Dt({color:4864552,roughness:1}),o=new oe(new Pn(.18,.26,1,6),a,r),c=new Dt({color:3366959,roughness:1,flatShading:!0}),l=new oe(new da(1,0),c,r),u=e/2+7;let h=0,d=0;for(;h<r&&d<r*4;){d++;const p=s()*n,v=(s()<.5?-1:1)*(u+s()*s()*150),m=3+Math.floor(s()*5);for(let f=0;f<m&&h<r;f++){const x=p+(s()-.5)*28,E=v+(s()-.5)*22;if(Math.abs(E)<u||x<0||x>n||qn(t,x)||$n(t,x,E))continue;const S=ue(t,x,E),w=Ii(t,x,E,0),b=4+s()*7,T=b*.45;Wn(o,h,S.x,w+T/2,S.z,1,T,1);const _=b*.42;Ce.compose(Ms.set(S.x,w+T+_*.7,S.z),Es,Ss.set(_,_*1.25,_)),l.setMatrixAt(h,Ce),h++}}for(let p=h;p<r;p++)Wn(o,p,0,-1e3,0,1,1,1),Wn(l,p,0,-1e3,0,1,1,1);o.instanceMatrix.needsUpdate=!0,l.instanceMatrix.needsUpdate=!0,o.frustumCulled=!1,l.frustumCulled=!1,i.add(o),i.add(l)}function _v(i,t,e){const n=t.length,s=sr(1234567),r=520,a=new Dt({color:2904360,roughness:1,flatShading:!0}),o=new oe(new da(1,0),a,r),c=e/2+6;let l=0,u=0;for(;l<r&&u<r*4;){u++;const h=s()*n,p=(s()<.5?-1:1)*(c+s()*s()*90),g=4+Math.floor(s()*6);for(let v=0;v<g&&l<r;v++){const m=h+(s()-.5)*24,f=p+(s()-.5)*10;if(Math.abs(f)<c||m<0||m>n||qn(t,m)||$n(t,m,f))continue;const x=ue(t,m,f),E=Ii(t,m,f,0),S=.7+s()*.9,w=.5+s()*.5;Ce.compose(Ms.set(x.x,E+w*.8,x.z),Es,Ss.set(S,w,S)),o.setMatrixAt(l,Ce),l++}}for(let h=l;h<r;h++)Wn(o,h,0,-1e3,0,1,1,1);o.instanceMatrix.needsUpdate=!0,o.frustumCulled=!1,i.add(o)}function xv(i,t,e){const n=t.length,s=sr(20260617),r=240,a=ov(4),o=new Dt({map:a.albedo,emissiveMap:a.emissive,emissive:16777215,emissiveIntensity:0,roughness:.88}),c=new oe(new Wt(1,1,1),o,r),l=[11569256,13154458,11053744,12560516,12764352,10259058],u=e/2+12,h=new Bt,d=[{c:700,half:1100,maxH:26,reach:150},{c:2e3,half:700,maxH:12,reach:110}];let p=0,g=0;for(;p<r&&g<r*6;){g++;const v=d[Math.floor(s()*d.length)];if(!v)continue;const m=v.c+(s()-.5)*2*v.half;if(m<0||m>n)continue;const x=(s()<.5?-1:1)*(u+s()*s()*v.reach);if(qn(t,m)||$n(t,m,x))continue;const E=ue(t,m,x),S=Ii(t,m,x,0),b=4+(1-Math.min(1,Math.abs(x)/(u+v.reach)))*v.maxH*(.4+s()*.6),T=5+s()*9,_=5+s()*9;Ce.compose(Ms.set(E.x,S+b/2,E.z),Es,Ss.set(T,b,_)),c.setMatrixAt(p,Ce);const y=l[Math.floor(s()*l.length)]??3816772;c.setColorAt(p,h.setHex(y)),p++}for(let v=p;v<r;v++)Wn(c,v,0,-1e3,0,1,1,1);return c.instanceMatrix.needsUpdate=!0,c.instanceColor&&(c.instanceColor.needsUpdate=!0),c.frustumCulled=!1,i.add(c),o}function io(i,t,e,n,s){if(n<0||n>t.length||qn(t,n)||$n(t,n,0))return;const r=new Dt({color:s,roughness:.9}),a=16,o=ye(t,n),c=6.2,l=o+c,u=.7,h=ue(t,n,0),d=new ve;d.position.set(h.x,0,h.z),d.quaternion.setFromAxisAngle(hc,h.heading);const p=new Ft(new Wt(a,u,4.5),r);p.position.set(0,l,0),d.add(p);for(const g of[-2,2]){const v=new Ft(new Wt(a,1,.3),r);v.position.set(0,l+.85,g),d.add(v)}for(const g of[-5.2175,e/2+4.5]){const v=new Ft(new Wt(3,c,5),r);v.position.set(g*1.6,o+c/2,0),d.add(v)}i.add(d)}function vv(i,t,e){if(e>t.length||qn(t,e)||$n(t,e,0))return;const n=ye(t,e),s=n+6.2,r=22,o=s+5.5,c=7,l=r/c,u=r/2,h=3,d=ue(t,e,0),p=new ve;p.position.set(d.x,0,d.z),p.quaternion.setFromAxisAngle(hc,d.heading);const g=[],v=(P,L,B,N,F,H,Z)=>{g.push({a:new U(P,L,B),b:new U(N,F,H),r:Z})};for(const P of[-h,h]){v(-u,s,P,u,s,P,.16),v(-u,o,P,u,o,P,.16);for(let L=0;L<=c;L++){const B=-u+L*l;v(B,s,P,B,o,P,.09)}for(let L=0;L<c;L++){const B=-u+L*l,N=B+l,F=L%2===0;v(B,F?s:o,P,N,F?o:s,P,.09)}v(-u,n,P,-u,s,P,.18),v(u,n,P,u,s,P,.18)}for(let P=0;P<=c;P++){const L=-u+P*l;v(L,o,-h,L,o,h,.07)}const m=new Dt({color:4608095,metalness:.85,roughness:.34,envMapIntensity:1.8,emissive:2898509,emissiveIntensity:.6}),f=new oe(new Pn(1,1,1,7),m,g.length),x=new U,E=new U,S=new Ve,w=new U;for(let P=0;P<g.length;P++){const L=g[P];if(!L)continue;x.subVectors(L.b,L.a);const B=Math.max(.01,x.length());E.addVectors(L.a,L.b).multiplyScalar(.5),S.setFromUnitVectors(hc,x.normalize()),w.set(L.r,B,L.r),Ce.compose(E,S,w),f.setMatrixAt(P,Ce)}f.instanceMatrix.needsUpdate=!0,f.frustumCulled=!1,p.add(f);const b=new Ft(new Wt(r,.4,h*2),new Dt({color:2106153,roughness:.9}));b.position.set(0,s,0),p.add(b);const T=new Dt({color:2240580,emissive:12769023,emissiveIntensity:2.4}),_=new oe(new ln(.13,8,8),T,(c+1)*2);let y=0;for(const P of[-h,h])for(let L=0;L<=c;L++)Wn(_,y++,-u+L*l,o,P,1,1,1);_.instanceMatrix.needsUpdate=!0,_.frustumCulled=!1,p.add(_);const I=new Dt({color:1710618,emissive:16769712,emissiveIntensity:2.6}),C=new oe(new ln(.14,8,8),I,c+1);for(let P=0;P<=c;P++)Wn(C,P,-u+P*l,s+.5,h,1,1,1);C.instanceMatrix.needsUpdate=!0,C.frustumCulled=!1,p.add(C),i.add(p)}function Mv(i,t,e){const n=sr(54321),s=e/2+.7+1,r=.9,a=[9059122,3297390,3493946,5917234,4211274],o=t.stations.length*4,c=new oe(new zc(.22,.9,3,6),new Dt({roughness:1}),o),l=new oe(new ln(.16,8,6),new Dt({color:13150602,roughness:1}),o),u=new Bt;let h=0;for(const d of t.stations){const p=ye(t,d.chainage)+r,g=4;for(let v=0;v<g;v++){const m=d.chainage+(n()-.5)*2*(d.platformHalf-12),f=s+(n()-.5)*1.4,x=ue(t,m,f);Ce.compose(Ms.set(x.x,p+.85,x.z),Es,Ss.set(1,1,1)),c.setMatrixAt(h,Ce);const E=a[v%a.length]??8421504;c.setColorAt(h,u.setHex(E)),Ce.compose(Ms.set(x.x,p+1.55,x.z),Es,Ss.set(1,1,1)),l.setMatrixAt(h,Ce),h++}}c.instanceMatrix.needsUpdate=!0,c.instanceColor&&(c.instanceColor.needsUpdate=!0),l.instanceMatrix.needsUpdate=!0,i.add(c),i.add(l)}const _u=200,Sv=900,xu=1.435,Ev=.25,yv=.07,so=.12,vu=.06,bv=2.6,Mu=.12,Av=.25,Su=.65,wv=1.9,Eu=.34,ro=.35,Tv=.08,yu=40,Rv=2.4,Cv=3,ao=1.6,oo=3.2,Pv=2.2,Lv=1.5,bu=5.5,Au=7.5,co=8.5,Gs=1.4;function lo(i,t,e){i.map=t.albedo,i.normalMap=t.normal,i.envMapIntensity=e,i.needsUpdate=!0}function Dv(i,t,e,n=1){const s=cv(n),r=[s],a=f=>{r.push(f)},o=new ve;i.add(o);const c=new Dt({color:16777215,roughness:1}),l=s.ground.albedo.clone(),u=s.ground.normal.clone();l.needsUpdate=!0,u.needsUpdate=!0,l.repeat.set(8,8),u.repeat.set(8,8),c.map=l,c.normalMap=u,c.envMapIntensity=Ev,a(c),a(l),a(u),Iv(o,t,e,c,a);const h=new Dt({color:5923438,metalness:.95,roughness:ro});lo(h,s.rail,1),a(h);const d=new Dt({color:16777215,roughness:1});lo(d,s.ballast,.15),a(d);const p=new Dt({color:2762274,roughness:.95});a(p),Uv(o,t,e,h,d,p,a);const g=new Dt({color:16777215,roughness:.92});lo(g,s.masonry,.2),a(g);const v=[];Nv(o,t,g,v,a);const m=Fv(o,t,g,a);return Bv(o,t,v,a),{group:o,railMaterial:h,waterMaterials:v,boreLight:m,railRoughnessFor(f){const x=f<0?0:f>1?1:f;return ro+(Tv-ro)*x},dispose(){i.remove(o),zv(o);for(const f of r)f.dispose()}}}function Iv(i,t,e,n,s){const r=-_u,a=t.length+_u,o=Math.max(1,e.terrainSegLen),c=Math.max(1,Math.ceil((a-r)/o)),l=c+1,u=Math.max(2,e.terrainSubdiv)+1,h=e.ribbonHalfWidth,d=new Float32Array(l*u*3),p=new Float32Array(l*u*2),g=_=>r+_/c*(a-r),v=_=>-h+_/(u-1)*(2*h);for(let _=0;_<l;_++){const y=g(_);for(let I=0;I<u;I++){const C=v(I),P=ue(t,y,C),L=ci(t,y,C),B=(_*u+I)*3;d[B]=P.x,d[B+1]=L,d[B+2]=P.z;const N=(_*u+I)*2;p[N]=y/40,p[N+1]=C/40}}const m=new Float32Array(l*u*3),f=(_,y,I)=>{const C=_<0?0:_>=l?l-1:_,P=y<0?0:y>=u?u-1:y,L=(C*u+P)*3;return I.set(d[L]??0,d[L+1]??0,d[L+2]??0)},x=new U,E=new U,S=new U,w=new U,b=new U;for(let _=0;_<l;_++)for(let y=0;y<u;y++){f(_+1,y,x),f(_-1,y,E),S.subVectors(x,E),f(_,y+1,x),f(_,y-1,E),w.subVectors(x,E),b.crossVectors(w,S),b.y<0&&b.negate(),b.normalize();const I=(_*u+y)*3;m[I]=b.x,m[I+1]=b.y,m[I+2]=b.z}const T=Math.max(1,Math.round(Sv/o));for(let _=0;_<c;_+=T){const I=Math.min(c,_+T)-_+1,C=I*u,P=new Float32Array(C*3),L=new Float32Array(C*3),B=new Float32Array(C*2);for(let Z=0;Z<I;Z++){const $=_+Z;for(let Q=0;Q<u;Q++){const ct=($*u+Q)*3,st=(Z*u+Q)*3;P[st]=d[ct]??0,P[st+1]=d[ct+1]??0,P[st+2]=d[ct+2]??0,L[st]=m[ct]??0,L[st+1]=m[ct+1]??0,L[st+2]=m[ct+2]??0;const Pt=($*u+Q)*2,$t=(Z*u+Q)*2;B[$t]=p[Pt]??0,B[$t+1]=p[Pt+1]??0}}const N=[];for(let Z=0;Z<I-1;Z++)for(let $=0;$<u-1;$++){const Q=Z*u+$,ct=(Z+1)*u+$,st=Z*u+($+1),Pt=(Z+1)*u+($+1);N.push(Q,ct,Pt,Q,Pt,st)}if(N.length===0)continue;const F=new Me;F.setAttribute("position",new Fe(P,3)),F.setAttribute("normal",new Fe(L,3)),F.setAttribute("uv",new Fe(B,2)),F.setIndex(N),F.computeBoundingSphere(),s(F);const H=new Ft(F,n);H.receiveShadow=!0,i.add(H)}}function Uv(i,t,e,n,s,r,a){const o=t.length,c=Math.max(2,e.terrainSegLen),l=Math.max(1,Math.ceil(o/c)),u=new Wt(yv,so,1);a(u);const h=new Wt(wv*2,.3,1);a(h);const d=new oe(u,n,l),p=new oe(u,n,l),g=new oe(h,s,l);g.receiveShadow=!0;const v=new te,m=new U,f=new Ve,x=new ke(0,0,0,"YXZ"),E=new U(1,1,1);for(let T=0;T<l;T++){const _=T*c,y=Math.min(o,(T+1)*c),I=(_+y)/2,C=y-_,P=on(t,I),L=ye(t,I);x.set(0,P,0),f.setFromEuler(x);const B=ue(t,I,0);E.set(1,1,C),m.set(B.x,L-Eu-.15,B.z),v.compose(m,f,E),g.setMatrixAt(T,v);const N=ue(t,I,-xu/2);m.set(N.x,L+vu-so/2,N.z),v.compose(m,f,E),d.setMatrixAt(T,v);const F=ue(t,I,xu/2);m.set(F.x,L+vu-so/2,F.z),v.compose(m,f,E),p.setMatrixAt(T,v)}d.instanceMatrix.needsUpdate=!0,p.instanceMatrix.needsUpdate=!0,g.instanceMatrix.needsUpdate=!0,i.add(d,p,g);const S=new Wt(bv,Mu,Av);a(S);const w=Math.max(1,Math.floor(o/Su)),b=new oe(S,r,w);for(let T=0;T<w;T++){const _=(T+.5)*Su,y=on(t,_),I=ue(t,_,0),C=ye(t,_);x.set(0,y,0),f.setFromEuler(x),E.set(1,1,1),m.set(I.x,C-Eu+Mu/2,I.z),v.compose(m,f,E),b.setMatrixAt(T,v)}b.instanceMatrix.needsUpdate=!0,i.add(b)}function Nv(i,t,e,n,s){const r=t.viaducts;if(!r||r.length===0)return;const a=new te,o=new U,c=new Ve,l=new ke(0,0,0,"YXZ"),u=new U(1,1,1),h=8;let d=0,p=0;for(const S of r){const w=S.center-S.halfLen,b=S.center+S.halfLen;d+=Math.max(1,Math.ceil((b-w)/h));const T=Math.max(2,Math.floor((b-w)/yu)+1);p+=T*2}const g=new Wt(oo*2,ao,h+.2);s(g);const v=new oe(g,e,d);v.castShadow=!0,v.receiveShadow=!0;const m=new Wt(Rv,1,Cv);s(m);const f=new oe(m,e,p);f.castShadow=!0;let x=0,E=0;for(const S of r){const w=S.center-S.halfLen,b=S.center+S.halfLen,T=Math.max(1,Math.ceil((b-w)/h));for(let L=0;L<T;L++){const B=w+(L+.5)*(b-w)/T,N=on(t,B),F=ue(t,B,0),H=ye(t,B);l.set(0,N,0),c.setFromEuler(l),u.set(1,1,1),o.set(F.x,H-ao/2-.5,F.z),a.compose(o,c,u),v.setMatrixAt(x++,a)}const _=Math.max(2,Math.floor((b-w)/yu)+1);for(let L=0;L<_;L++){const B=_===1?S.center:w+L/(_-1)*(b-w),N=on(t,B),F=ye(t,B);l.set(0,N,0),c.setFromEuler(l);for(const H of[-1,1]){const Z=H*Pv,$=ue(t,B,Z),Q=ci(t,B,Z),ct=F-ao-.5,st=Math.max(.5,ct-Q);u.set(1,st,1),o.set($.x,Q+st/2,$.z),a.compose(o,c,u),f.setMatrixAt(E++,a)}}const y=ue(t,S.center,0);ci(t,S.center,0);const I=new As(80,S.halfLen*2+60);s(I);const C=new Dt({color:2243146,roughness:.12,metalness:.5});C.envMapIntensity=.8,s(C),n.push(C);const P=new Ft(I,C);P.rotation.x=-Math.PI/2,P.rotation.z=on(t,S.center),P.position.set(y.x,ye(t,S.center)-S.valleyDepth+Lv,y.z),i.add(P);for(const L of[w,b]){const B=on(t,L),N=ue(t,L,0),F=ye(t,L),H=ci(t,L,oo+4),Z=Math.max(2,F-H+2),$=new Wt(oo*2+4,Z,5);s($);const Q=new Ft($,e);Q.castShadow=!0,Q.receiveShadow=!0,l.set(0,B,0),c.setFromEuler(l),u.set(1,1,1),o.set(N.x,F-Z/2,N.z),Q.position.copy(o),Q.quaternion.copy(c),i.add(Q)}}v.instanceMatrix.needsUpdate=!0,f.instanceMatrix.needsUpdate=!0,i.add(v,f)}function Fv(i,t,e,n){const s=t.tunnels;if(!s||s.length===0)return null;const r=10,a=new Dt({color:329226,roughness:1,metalness:0,side:Ge});n(a);const o=new te,c=new U,l=new Ve,u=new ke(0,0,0,"YXZ"),h=new U(1,1,1);let d=0;for(const f of s)d+=Math.max(1,Math.ceil(2*f.halfLen/r));const p=new Pn(bu,bu,r+.2,16,1,!0,0,Math.PI);n(p);const g=new oe(p,a,d);let v=null,m=0;for(const f of s){const x=f.center-f.halfLen,E=f.center+f.halfLen,S=Math.max(1,Math.ceil(2*f.halfLen/r));for(let w=0;w<S;w++){const b=x+(w+.5)*(E-x)/S,T=on(t,b),_=ue(t,b,0),y=ye(t,b);u.set(Math.PI/2,T,0),l.setFromEuler(u),h.set(1,1,1),c.set(_.x,y+.2,_.z),o.compose(c,l,h),g.setMatrixAt(m++,o)}for(const w of[x,E]){const b=on(t,w),T=ue(t,w,0),_=ye(t,w),y=Ov(e,n);u.set(0,b,0),y.quaternion.setFromEuler(u),y.position.set(T.x,_,T.z),i.add(y)}if(!v){const w=ue(t,E,0),b=ye(t,E);v=new Wc(6978192,.6,90,1.5),v.position.set(w.x,b+2.5,w.z),i.add(v)}}return g.instanceMatrix.needsUpdate=!0,i.add(g),v}function Ov(i,t){const e=new ve,n=new Wt(Gs,co*2,Gs);t(n);for(const a of[-1,1]){const o=new Ft(n,i);o.position.set(a*Au,co,0),o.castShadow=!0,e.add(o)}const s=new Wt(Au*2+Gs,Gs,Gs);t(s);const r=new Ft(s,i);return r.position.set(0,co*2,0),r.castShadow=!0,e.add(r),e}function Bv(i,t,e,n){const s=t.stations.find(x=>/coast|brine/i.test(x.name)),r=t.stations[t.stations.length-1];if(!r)return;const a=s?s.chainage:t.length*.75,o=r.chainage,c=(a+o)/2;if(!t.tunnels&&!t.viaducts)return;const l=on(t,c),u=2e3,d=ue(t,c,120+u/2),p=o-a+600,g=ye(t,o)-6,v=new As(u,p);n(v);const m=new Dt({color:1454399,roughness:.1,metalness:.6});m.envMapIntensity=1,n(m),e.push(m);const f=new Ft(v,m);f.rotation.x=-Math.PI/2,f.rotation.z=l,f.position.set(d.x,g,d.z),i.add(f)}function zv(i){i.traverse(t=>{const e=t;e.geometry&&typeof e.geometry.dispose=="function"&&e.geometry.dispose();const n=e.material;if(Array.isArray(n))for(const s of n)s.dispose();else n&&typeof n.dispose=="function"&&n.dispose()})}const Gv=2.236936,qs={RED:16720920,YELLOW:16756768,DOUBLE_YELLOW:16756768,GREEN:3211104},Hv=18,uo=16,ho=40,kv=22,Vv=.35,Gn=1.435,Wv=.5,wu=4,fo=140,Hs=100,Tu=2048,Xv=2400,Yv=2;function Ru(i,t,e,n){const s=1-Math.exp(-4*Math.max(0,n));return i+(t-i)*s}function qv(i,t,e){const n=e?.rainCount??Xv,s=e?.pixelRatioCap??Yv,r=e?.shadowsEnabled??!1,a=e?.bloomEnabled??!1,o=e?.attitudeScale??0,c={ribbonHalfWidth:e?.ribbonHalfWidth??110,terrainSegLen:e?.terrainSegLen??20,terrainSubdiv:e?.terrainSubdiv??10},l=new Rx({antialias:!0});l.setPixelRatio(Math.min(window.devicePixelRatio,s)),l.setSize(i.clientWidth,i.clientHeight),l.outputColorSpace=Ue,l.toneMapping=yc,l.toneMappingExposure=1,r&&(l.shadowMap.enabled=!0,l.shadowMap.type=Ku),i.appendChild(l.domElement);const u=l.capabilities.getMaxAnisotropy(),h=new up;h.background=new Bt(329743),h.fog=new Uc(329743,25,260);const d=new en(70,i.clientWidth/i.clientHeight,.05,4e3);d.rotation.order="YXZ";const p=.0042;let g=0,v=0,m=!1,f=0,x=0;const E=l.domElement;E.addEventListener("pointerdown",q=>{if(q.button===0){m=!0,f=q.clientX,x=q.clientY;try{E.setPointerCapture(q.pointerId)}catch{}}}),E.addEventListener("pointermove",q=>{m&&(g-=(q.clientX-f)*p,v-=(q.clientY-x)*p,f=q.clientX,x=q.clientY,g=Math.max(-2.4,Math.min(2.4,g)),v=Math.max(-.7,Math.min(.7,v)))});const S=q=>{if(m){m=!1;try{E.releasePointerCapture(q.pointerId)}catch{}}};E.addEventListener("pointerup",S),E.addEventListener("pointercancel",S);const w={topColor:{value:new Bt(329743)},bottomColor:{value:new Bt(660008)},offset:{value:33},exponent:{value:.6}},b=new _n({uniforms:w,side:Ge,depthWrite:!1,fog:!1,vertexShader:`
      varying vec3 vWorldPosition;
      void main() {
      ...
      }`}),T=new Ft(new ln(3e3,24,12),b);h.add(T);let _=gu(329743,922639);h.environment=_;let y=329743,I=922639;const C=new Cp(1713718,197642,.35);h.add(C);const P=new Ol(9085128,.4);P.position.set(-40,80,-20),h.add(P);const L=new Ol(16777215,0),B=new Ee;if(h.add(L),h.add(B),L.target=B,r){L.castShadow=!0,L.shadow.mapSize.set(Tu,Tu);const q=L.shadow.camera;q.left=-Hs,q.right=Hs,q.top=Hs,q.bottom=-Hs,q.near=1,q.far=fo+Hs*2,q.updateProjectionMatrix(),L.shadow.bias=-4e-4,L.shadow.normalBias=.6}const N=Dv(h,t,c,u);for(const q of t.stations)Jv(h,t,q);const F=$v(h,t);Zv(h,t);const H=fv(h,t,Gn),Z=mv(h,t,Gn);jv(h,t);const $=new Float32Array(n*3);for(let q=0;q<n;q++)$[q*3+0]=(Math.random()*2-1)*Hv,$[q*3+1]=Math.random()*2*uo,$[q*3+2]=(Math.random()*2-1)*ho;const Q=new Me;Q.setAttribute("position",new Fe($,3));const ct=dv(),st=new oc({color:10467032,map:ct,size:.06,transparent:!0,opacity:.5,depthWrite:!1,fog:!1}),Pt=new Ll(Q,st);Pt.frustumCulled=!1,h.add(Pt);const $t=2200,ie=new U(-.2,.4,.9).normalize(),K=new ve;K.frustumCulled=!1;const rt=new Fc({color:15660031,fog:!1,transparent:!0,depthWrite:!1}),nt=new Ft(new ln(40,24,16),rt);nt.position.copy(ie).multiplyScalar($t),K.add(nt);const Ot=new Nc({map:hv(12374783),blending:jr,depthWrite:!1,transparent:!0,fog:!1}),At=new xd(Ot);At.scale.set(820,820,1),At.position.copy(ie).multiplyScalar($t-40),K.add(At);const Lt=520;let ae=439041101;const Yt=()=>{ae=ae+1831565813>>>0;let q=Math.imul(ae^ae>>>15,1|ae);return q=q+Math.imul(q^q>>>7,61|q)^q,((q^q>>>14)>>>0)/4294967296},Kt=new Float32Array(Lt*3);for(let q=0;q<Lt;q++){const it=Yt()*Math.PI*2,wt=Math.acos(Yt()*.62+.16),Nt=$t+180;Kt[q*3+0]=Nt*Math.sin(wt)*Math.cos(it),Kt[q*3+1]=Nt*Math.cos(wt),Kt[q*3+2]=Nt*Math.sin(wt)*Math.sin(it)}const se=new Me;se.setAttribute("position",new Fe(Kt,3));const gt=new oc({color:12570879,size:2,sizeAttenuation:!1,fog:!1,transparent:!0,depthWrite:!1}),Zt=new Ll(se,gt);Zt.frustumCulled=!1,K.add(Zt),h.add(K);const D=new ve;h.add(D);const Qt=ev(D,Wv),It={powerFrac:0,brakeFrac:0,reverser:"OFF",speedMph:0,sunflower:"BLACK",dra:!1,dsd:!1,penalty:!1,wiperOn:!0,dt:0};let jt=null,_t=null,R=!1,M=!1;function z(){R||jt||M||(R=!0,Promise.all([ar(()=>import("./EffectComposer-CBVnDMJH.js"),__vite__mapDeps([0,1,2]),import.meta.url),ar(()=>import("./RenderPass-BK-XlbCC.js"),__vite__mapDeps([3,2]),import.meta.url),ar(()=>import("./UnrealBloomPass-Cs_44dsl.js"),__vite__mapDeps([4,2,1]),import.meta.url),ar(()=>import("./OutputPass-DsYV25iG.js"),__vite__mapDeps([5,2]),import.meta.url)]).then(([q,it,wt,Nt])=>{const me=new zt(i.clientWidth,i.clientHeight),Pe=new q.EffectComposer(l);Pe.addPass(new it.RenderPass(h,d));const We=new wt.UnrealBloomPass(me,.6,.6,.85);Pe.addPass(We),Pe.addPass(new Nt.OutputPass),Pe.setSize(i.clientWidth,i.clientHeight),jt=Pe,_t=We}).catch(()=>{M=!0,R=!1}))}const j=new U;let J=0,Y=0;function Mt(q){for(let it=0;it<F.length;it++){const wt=F[it];if(!wt)continue;const Nt=wi(t,it,q.served);wt.red.emissiveIntensity=Nt==="RED"?1.4:0,wt.amberTop.emissiveIntensity=Nt==="YELLOW"||Nt==="DOUBLE_YELLOW"?1.3:0,wt.amberBot.emissiveIntensity=Nt==="DOUBLE_YELLOW"?1.3:0,wt.green.emissiveIntensity=Nt==="GREEN"?1.3:0;const me=wt.glow.material;me.color.setHex(qs[Nt]),me.opacity=.55}}function lt(q,it,wt,Nt){const me=q.dt,Pe=kv*me,We=Pe*Vv+Math.abs(q.speed)*me*.25,xn=Q.getAttribute("position"),Xe=xn.array;for(let Le=0;Le<n;Le++){const De=Le*3+1,Ze=Le*3+2;let sn=Xe[De]-Pe,un=Xe[Ze]-We;sn<0&&(sn+=2*uo),un<-ho&&(un+=2*ho),Xe[De]=sn,Xe[Ze]=un}xn.needsUpdate=!0,Pt.position.set(it,wt-uo,Nt)}function Rt(q){const it=q.env,wt=q.chainage,Nt=Kx(t,wt,Xx,Wx),me=Yh(t,wt).cant,Pe=$r(t,wt),We=$x(me,Pe,o);J=Ru(J,We.pitch,wu,q.dt),Y=Ru(Y,We.roll,wu,q.dt),d.position.set(Nt.x,Nt.y,Nt.z),d.rotation.set(J+v,Nt.heading+Math.PI+g,Y),D.position.set(Nt.x,Nt.y,Nt.z),D.rotation.set(J,Nt.heading+Math.PI,Y),l.toneMappingExposure=it.exposure,h.background.setHex(it.skyColor),w.topColor.value.setHex(it.skyColor).multiplyScalar(.88-.56*it.nightFactor),w.bottomColor.value.setHex(it.skyColor);const xn=h.fog;xn.color.setHex(it.skyColor),xn.near=it.fogNear,xn.far=it.fogFar,C.color.setHex(it.hemiSky),C.groundColor.setHex(it.hemiGround),C.intensity=it.ambientIntensity,P.color.setHex(it.sunColor),P.intensity=it.moonIntensity,j.set(it.sunDir.x,it.sunDir.y,it.sunDir.z),P.position.copy(j).multiplyScalar(fo),st.opacity=it.rainIntensity,N.railMaterial.roughness=N.railRoughnessFor(it.railWetness),H.buildingMat.emissiveIntensity=1.9*it.nightFactor,r&&(B.position.set(Nt.x,Nt.y,Nt.z),L.position.copy(B.position).addScaledVector(j,fo),L.color.setHex(it.sunColorPbr),L.intensity=it.moonIntensity),(it.skyColor!==y||it.groundColor!==I)&&(uv(_),_=gu(it.skyColor,it.groundColor),h.environment=_,y=it.skyColor,I=it.groundColor);const Xe=it.nightFactor;K.visible=Xe>.01,K.visible&&(K.position.set(Nt.x,Nt.y,Nt.z),rt.opacity=Xe,Ot.opacity=.85*Xe,gt.opacity=Xe),Mt(q),Z.update(q.dt),it.rainIntensity>0&&lt(q,Nt.x,Nt.y,Nt.z);const Le=q.controls;if(It.powerFrac=Le.powerNotch/Ci,It.brakeFrac=Le.brakeStep/yi,It.reverser=Le.reverser,It.speedMph=Math.abs(q.speed)*Gv,It.sunflower=q.aws.sunflower,It.dra=Le.dra,It.dsd=q.safety.dsdWarning,It.penalty=er(q.safety),It.wiperOn=it.wiperOn,It.dt=q.dt,Qt.update(It),a&&(jt||z(),jt&&_t)){_t.strength=it.bloomStrength,jt.render();return}l.render(h,d)}function Ut(){const q=i.clientWidth,it=i.clientHeight;l.setSize(q,it),d.aspect=q/it,d.updateProjectionMatrix(),jt&&jt.setSize(q,it)}const tt=new Dt({color:2832981,roughness:.5,metalness:.2}),at=new Dt({color:1054752,emissive:2240580,emissiveIntensity:.6,roughness:.3}),vt=19,Et=1.2,pt=2.7,Ht=3.6,O=.2;function ut(){const q=new ve;for(let it=0;it<4;it++){const wt=new ve,Nt=new Ft(new Wt(pt,Ht,vt),tt);Nt.castShadow=!0,wt.add(Nt);const me=new Ft(new Wt(pt+.02,.7,vt-2),at);me.position.y=.5,wt.add(me),wt.position.set(0,O+Ht/2,-9.5-it*(vt+Et)),q.add(wt)}return q.visible=!1,q}function ot(){const q=ut();return h.add(q),{setPose(it){q.position.set(it.x,it.y,it.z),q.rotation.set(0,it.heading,0)},setVisible(it){q.visible=it}}}const mt=new Dt({color:2762274,roughness:.95}),et=.06,X=.12;function St(q){const it=q.route.length,wt=6,Nt=Math.max(1,Math.ceil(it/wt)),me=new Wt(.07,X,1),Pe=new oe(me,N.railMaterial,Nt),We=new oe(me,N.railMaterial,Nt),xn=new Wt(2.6,.12,.25),Xe=Math.max(1,Math.floor(it/.65)),Le=new oe(xn,mt,Xe);Le.receiveShadow=!0;const De=new te,Ze=new U,sn=new Ve,un=new ke(0,0,0,"YXZ"),vn=new U(1,1,1);for(let $e=0;$e<Nt;$e++){const Mn=$e*wt,Dn=Math.min(it,($e+1)*wt),Oi=(Mn+Dn)/2;un.set(0,Zr(q,Oi).heading,0),sn.setFromEuler(un),vn.set(1,1,Dn-Mn);const Ts=zr(q,Oi,-Gn/2);Ze.set(Ts.x,Ts.y+et-X/2,Ts.z),De.compose(Ze,sn,vn),Pe.setMatrixAt($e,De);const Rs=zr(q,Oi,Gn/2);Ze.set(Rs.x,Rs.y+et-X/2,Rs.z),De.compose(Ze,sn,vn),We.setMatrixAt($e,De)}vn.set(1,1,1);for(let $e=0;$e<Xe;$e++){const Mn=($e+.5)*.65;un.set(0,Zr(q,Mn).heading,0),sn.setFromEuler(un);const Dn=zr(q,Mn,0);Ze.set(Dn.x,Dn.y-.28,Dn.z),De.compose(Ze,sn,vn),Le.setMatrixAt($e,De)}Pe.instanceMatrix.needsUpdate=!0,We.instanceMatrix.needsUpdate=!0,Le.instanceMatrix.needsUpdate=!0,h.add(Pe,We,Le)}return{render:Rt,resize:Ut,addTrainMesh:ot,addEdgeTrack:St}}function $v(i,t){const e=[],n=Gn/2+2.2,s=new ln(.16,12,12),r=new Pn(.23,.23,.26,12,1,!0),a=Qv(),o=new Dt({color:7107194,roughness:.7,metalness:.4}),c=new Dt({color:329482,roughness:.95}),l=new Dt({color:658189,roughness:.9,side:An}),u=new Ve().setFromUnitVectors(new U(0,1,0),new U(0,0,1));for(const h of t.signals){const d=new ve,p=ue(t,h.chainage,n),g=ci(t,h.chainage,n);d.position.set(p.x,g,p.z),d.rotation.y=p.heading+Math.PI;const v=new Ft(new Pn(.09,.12,4.2,10),o);v.position.y=2.1,d.add(v);const m=new Ft(new Wt(.62,1.55,.1),c);m.position.set(0,4,0),d.add(m);const f=(T,_)=>{const y=new Dt({color:460551,emissive:new Bt(_),emissiveIntensity:0,roughness:.5}),I=new Ft(s,y);I.position.set(0,T,.3),d.add(I);const C=new Ft(r,l);return C.quaternion.copy(u),C.position.set(0,T,.36),d.add(C),y},x=f(4.63,qs.YELLOW),E=f(4.21,qs.GREEN),S=f(3.79,qs.YELLOW),w=f(3.37,qs.RED),b=new xd(new Nc({map:a,color:16777215,transparent:!0,opacity:0,blending:jr,depthWrite:!1,fog:!1}));b.scale.set(2.4,2.4,1),b.position.set(0,4,.1),d.add(b),i.add(d),e.push({red:w,amberTop:S,amberBot:x,green:E,glow:b})}return e}const Od=45,Kv=.2,fc=Gn/2+2.6,pc=5.9,ks=7;function Bd(i){return Math.max(1,Math.floor(i.length/Od))}function qc(i){return(i+1)*Od}function $c(i){return i%2===0?1:-1}function mc(i,t){const e=qc(t);return qn(i,e)||$n(i,e,$c(t)*fc)}function gc(i,t,e){const n=qc(t),s=$c(t)*Kv,r=ue(i,n,s);return e.set(r.x,ye(i,n)+pc,r.z),e}function Zv(i,t){const e=t.length,n=new te,s=new Ve,r=new ke(0,0,0,"YXZ"),a=new U(1,1,1),o=new U,c=-1e3,l=Bd(t),u=new Dt({color:2764599,roughness:.7,metalness:.55}),h=new oe(new Wt(.26,ks*.6,.26),u,l),d=new oe(new Wt(.16,ks*.45,.16),u,l),p=new oe(new Wt(2.4,.1,.1),u,l),g=new Dt({color:3817545,roughness:.6,metalness:.6}),v=new oe(new Wt(.05,1,.05),g,l),m=new U,f=new U,x=new U,E=new U(0,1,0);for(let N=0;N<l;N++){const F=qc(N),H=$c(N),Z=on(t,F);r.set(0,Z,0),s.setFromEuler(r);const $=ye(t,F);if(mc(t,N)){n.compose(o.set(0,c,0),s,a),h.setMatrixAt(N,n),d.setMatrixAt(N,n),p.setMatrixAt(N,n),v.setMatrixAt(N,n);continue}const Q=ue(t,F,H*fc);n.compose(o.set(Q.x,$+ks*.3,Q.z),s,a),h.setMatrixAt(N,n),n.compose(o.set(Q.x,$+ks*.6+ks*.225,Q.z),s,a),d.setMatrixAt(N,n);const ct=ue(t,F,H*(fc-1.2));n.compose(o.set(ct.x,$+pc+.45,ct.z),s,a),p.setMatrixAt(N,n),gc(t,N,m);const st=ct.x,Pt=$+pc+.45,$t=ct.z;f.set(m.x-st,m.y-Pt,m.z-$t);const ie=Math.max(.05,f.length());x.set((st+m.x)/2,(Pt+m.y)/2,($t+m.z)/2),s.setFromUnitVectors(E,f.normalize()),n.compose(x,s,a.set(1,ie,1)),v.setMatrixAt(N,n),a.set(1,1,1)}h.instanceMatrix.needsUpdate=!0,d.instanceMatrix.needsUpdate=!0,p.instanceMatrix.needsUpdate=!0,v.instanceMatrix.needsUpdate=!0,i.add(h,d,p,v);const S=6,w=Math.max(1,Math.floor(e/S)),b=Gn/2+4.5,T=new Dt({color:921878,roughness:.9}),_=new oe(new Wt(.06,1,.06),T,w*2);let y=0;for(let N=0;N<w;N++){const F=(N+1)*S,H=on(t,F);r.set(0,H,0),s.setFromEuler(r);for(const Z of[-1,1]){const $=Z*b;if(qn(t,F)||$n(t,F,$)){n.compose(o.set(0,c,0),s,a),_.setMatrixAt(y++,n);continue}const Q=ue(t,F,$);n.compose(o.set(Q.x,Ii(t,F,$,.5),Q.z),s,a),_.setMatrixAt(y++,n)}}_.instanceMatrix.needsUpdate=!0,i.add(_);const I=500,C=Math.max(1,Math.floor(e/I)),P=Gn/2+2,L=new Dt({color:11580602,roughness:.8}),B=new oe(new Wt(.1,.6,.1),L,C);for(let N=0;N<C;N++){const F=(N+1)*I,H=on(t,F);if(r.set(0,H,0),s.setFromEuler(r),qn(t,F)||$n(t,F,P)){n.compose(o.set(0,c,0),s,a),B.setMatrixAt(N,n);continue}const Z=ue(t,F,P);n.compose(o.set(Z.x,Ii(t,F,P,.3),Z.z),s,a),B.setMatrixAt(N,n)}B.instanceMatrix.needsUpdate=!0,i.add(B)}function jv(i,t){const e=Bd(t),n=Math.max(1,e-1),s=new Dt({color:2764340,roughness:.5,metalness:.6}),r=new oe(new Wt(.035,1,.035),s,n),a=new te,o=new Ve,c=new U(1,1,1),l=new U,u=new U,h=new U,d=new U,p=new U(0,1,0),g=-1e3;for(let v=0;v<n;v++){if(mc(t,v)||mc(t,v+1)){a.compose(l.set(0,g,0),o.identity(),c.set(1,1,1)),r.setMatrixAt(v,a);continue}gc(t,v,l),gc(t,v+1,u),h.set(u.x-l.x,u.y-l.y,u.z-l.z);const m=Math.max(.05,h.length());d.set((l.x+u.x)/2,(l.y+u.y)/2,(l.z+u.z)/2),o.setFromUnitVectors(p,h.normalize()),a.compose(d,o,c.set(1,m,1)),r.setMatrixAt(v,a)}r.instanceMatrix.needsUpdate=!0,i.add(r)}function Jv(i,t,e){const n=e.chainage,s=2*e.platformHalf,r=3,a=.9,o=Gn/2+.7,c=o+r/2,l=ye(t,n),u=new ve,h=ue(t,n,0);u.position.set(h.x,l,h.z),u.rotation.y=h.heading;const d=new Dt({color:5396575,roughness:.9}),p=new Dt({color:2896700,roughness:.85}),g=new Dt({color:2765115,roughness:.6,metalness:.4}),v=ci(t,n,c)-l,m=a-v,f=new Ft(new Wt(r,m,s),d);f.position.set(c,(a+v)/2,0),f.receiveShadow=!0,u.add(f);const x=new Ft(new Wt(.2,2.6,s),p);x.position.set(c+r/2-.1,a+1.3,0),u.add(x);const E=a+3,S=new Ft(new Wt(r,.12,s*.8),g);S.position.set(c,E,0),u.add(S);const w=new Wt(.12,E-a,.12);for(const y of[-s*.35,0,s*.35]){const I=new Ft(w,g);I.position.set(c-r/2+.3,a+(E-a)/2,y),u.add(I)}const b=new Ft(new Wt(.08,.5,3.2),new Dt({color:659488,emissive:new Bt(3238080),emissiveIntensity:2,roughness:.5}));b.position.set(o+.05,a+1.7,0),u.add(b);const T=new Qs(.12,16),_=new Dt({color:1053720,emissive:new Bt(16769712),emissiveIntensity:2.6,roughness:.5});for(const y of[-s*.3,s*.3]){const I=new Ft(T,_);I.position.set(c,a+3.4,y),I.rotation.x=Math.PI/2,u.add(I);const C=new Wc(16769712,3,24);C.position.set(c,a+3.3,y),u.add(C)}i.add(u)}function Qv(){const t=document.createElement("canvas");t.width=t.height=64;const e=t.getContext("2d");if(e){const s=e.createRadialGradient(32,32,0,32,32,32);s.addColorStop(0,"rgba(255,255,255,1)"),s.addColorStop(.4,"rgba(255,255,255,0.5)"),s.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=s,e.fillRect(0,0,64,64)}const n=new ir(t);return n.needsUpdate=!0,n}function tM(i){const t=document.createElement("div");t.style.cssText="position:fixed;left:14px;top:12px;font:14px/1.6 ui-monospace,monospace;color:#cfe0f5;text-shadow:0 1px 2px #000;pointer-events:none;display:grid;grid-template-columns:auto auto;gap:1px 12px";function e(b){const T=document.createElement("span");T.textContent=b,T.style.opacity="0.65";const _=document.createElement("span");return t.append(T,_),_}function n(b){const T=document.createElement("span");return T.textContent=b,T.style.cssText="padding:2px 8px;border-radius:3px;border:1px solid #2a3650;color:#5a6a82",T}const s=e("SPEED"),r=e("LIMIT"),a=e("REVERSER"),o=e("POWER"),c=e("BRAKE"),l=e("BRK D/A"),u=e("NEXT"),h=e("CHAINAGE"),d=e("ASPECT"),p=document.createElement("div");p.style.cssText="grid-column:1 / 3;margin-top:6px;display:flex;gap:10px";const g=n("DRA"),v=n("DSD"),m=n("PENALTY"),f=n("AWS");p.append(g,v,m,f),t.append(p);const x={RED:"#e04030",YELLOW:"#e0b020",DOUBLE_YELLOW:"#e0b020",GREEN:"#30c050"};i.appendChild(t);const E=document.createElement("div");E.id="mdtrain2-safety-prompt",E.style.cssText="position:fixed;left:50%;top:34%;transform:translate(-50%,-50%);font:700 30px/1.2 ui-monospace,monospace;letter-spacing:0.04em;padding:14px 26px;border-radius:8px;text-align:center;white-space:nowrap;text-shadow:0 2px 4px #000;pointer-events:none;display:none",i.appendChild(E);function S(b,T,_){T?(b.style.background=_,b.style.color="#0a0e16",b.style.borderColor=_):(b.style.background="transparent",b.style.color="#5a6a82",b.style.borderColor="#2a3650")}function w(b){s.textContent=`${b.speedMph.toFixed(0)} mph`,r.textContent=`${b.limitMph.toFixed(0)} mph`,a.textContent=b.reverser,o.textContent=`${b.powerNotch} of ${b.powerMax}`,c.textContent=b.brakeLabel,l.textContent=`${b.brakeDemandPct.toFixed(0)}% / ${b.brakeActualPct.toFixed(0)}%`,u.textContent=b.nextStop,h.textContent=`${b.chainage.toFixed(0)} m`,d.textContent=b.aspect,d.style.color=x[b.aspect],S(g,b.dra,"#e0b020"),S(v,b.dsdWarning,"#e0b020"),S(m,b.penalty,"#e04030"),S(f,b.sunflower==="CAUTION","#e0b020");const T=xh(b);T===null?E.style.display="none":(E.textContent=T,E.style.display="block",E.style.background=b.penalty?"rgba(160,16,16,0.92)":"rgba(150,110,0,0.92)",E.style.color=b.penalty?"#ffe6e0":"#fff4d0",E.style.border=b.penalty?"2px solid #ff6048":"2px solid #ffc838")}return{update:w}}const Cu="mdtrain2-help-style",mn="mdtrain2-help",eM=[{keys:"W / S",what:"Power up / down"},{keys:"D / A",what:"Brake on / off"},{keys:"F / N / R",what:"Reverser fwd / neutral / rev"},{keys:"Q",what:"Acknowledge AWS / reset penalty (at a stand)"},{keys:"L",what:"DRA (driver's reminder)"},{keys:"`",what:"Emergency brake"},{keys:"E",what:"Change weather / time of day"},{keys:"H",what:"Show / hide this panel"}],nM=`
#${mn} {
  position: fixed;
  top: 12px;
  right: 14px;
...
`;function xM(){if(document.getElementById(Pu))return;const i=document.createElement("style");i.id=Pu,i.textContent=_M,document.head.appendChild(i)}function vM(i){xM();const t={powerUp:!1,powerDown:!1,brakeUp:!1,brakeDown:!1,emergency:!1,reverserFwd:!1,reverserOff:!1,reverserRev:!1,toggleDra:!1,acknowledge:!1,cycleEnvironment:!1},e=document.createElement("div");e.id=os;for(const s of Lu){const r=document.createElement("button");r.type="button",r.textContent=s.text,r.setAttribute("aria-label",s.label),r.dataset.action=s.action,r.addEventListener("pointerdown",a=>{a.preventDefault(),t[s.action]=!0}),e.appendChild(r)}i.appendChild(e);function n(){let s=!1;const r={...ra};for(const a of Lu)t[a.action]&&(r[a.action]=!0,s=!0,t[a.action]=!1);return r.anyActivity=s,r}return{actions:n}}function MM(i){return i?{rainScale:0,wiperEnabled:!1}:{rainScale:1,wiperEnabled:!0}}const SM=2400,EM=900;function Du(i,t,e){return Number.isFinite(i)?Math.min(e,Math.max(t,i)):t}function yM(i){const t=i.coarsePointer?Du(i.maxDevicePixelRatio,1,1.5):Du(i.maxDevicePixelRatio,1,2),e=i.coarsePointer?{pixelRatioCap:t,rainCount:EM,shadowsEnabled:!1,bloomEnabled:!1,ribbonHalfWidth:90,terrainSegLen:20,terrainSubdiv:10,attitudeScale:0}:{pixelRatioCap:t,rainCount:SM,shadowsEnabled:!0,bloomEnabled:!0,ribbonHalfWidth:120,terrainSegLen:8,terrainSubdiv:24,attitudeScale:.35};return i.reducedMotion&&(e.rainCount=0,e.attitudeScale=0),e}const Kc=document.getElementById("app");if(!Kc)throw new Error("#app not found");const Ti=hf,Ui=Ti.graph,aa=Ws,Iu=Qh(Ui,Object.values(Ti.paths),Ti.stationNames,Ti.maxSpeed,120);if(Iu.length)throw new Error(`Track graph invalid:
${Iu.map(i=>`  ${i.kind}: ${i.detail}`).join(`
`)}`);const ls=Ti.paths.player,Zc={};{let i=0;for(const t of ls)Zc[t]=i,i+=Ui.edges[t].route.length}const Uu=i=>(Zc[i.edgeId]??0)+i.s,bM=i=>{for(const t of ls){const e=Ui.edges[t].route.length,n=Zc[t];if(i<n+e||t===ls[ls.length-1])return{edgeId:t,s:Math.max(0,Math.min(e,i-n)),d:0}}return{edgeId:ls[0],s:0,d:0}},zd=window.matchMedia("(prefers-reduced-motion: reduce)").matches,AM=window.matchMedia("(pointer: coarse)").matches,wM=yM({coarsePointer:AM,maxDevicePixelRatio:window.devicePixelRatio,reducedMotion:zd}),xa=qv(Kc,aa,wM),TM=tM(document.body);sM(document.body);const Gd=cM(),Nu=mM(),RM=gM(),CM=vM(Kc);let Ri=Ti.makeRecords();const po=Number(new URLSearchParams(location.search).get("s")??"");if(Number.isFinite(po)&&po>0){const i=bM(Math.max(0,Math.min(aa.length,po)));Ri=Ri.map(t=>t.id==="player"?{...t,pos:i,state:{...t.state,chainage:i.s}}:t)}for(const i of Object.keys(Ui.edges))ls.includes(i)||xa.addEdgeTrack(Ui.edges[i]);const Hd=new Map;for(const i of Ri)i.kind==="ai"&&Hd.set(i.id,xa.addTrainMesh());let ii=lh(),vi=uh(),Vs=Sh(),mo=go;window.addEventListener("resize",()=>xa.resize());function oa(){Gd.start(),window.removeEventListener("keydown",oa),window.removeEventListener("pointerdown",oa)}window.addEventListener("keydown",oa);window.addEventListener("pointerdown",oa);const Fu=()=>Ri.find(i=>i.id==="player");let Ou=performance.now();function kd(i){requestAnimationFrame(kd);const t=Math.min((i-Ou)/1e3,.05);Ou=i;const e=dM(fM(Nu.edges()),RM.actions(),CM.actions()),n=hM(e);e.cycleEnvironment&&(mo=zh(mo));const s=MM(zd),r=Oh(mo),a={...r,rainIntensity:r.rainIntensity*s.rainScale,wiperOn:r.wiperOn&&s.wiperEnabled},o=Fu(),c=Uu(o.pos),l={speed:o.state.speed,brakeActual:o.state.brakeActual,time:o.state.time};ii=hh(ii,n,l,vi);const u=fh(ii,vi,a.mu);Ri=lf(Ui,Ri,Ti.blockEdgeIds,t,a.mu,u);const h=Fu(),d=Uu(h.pos),p={chainage:d,speed:h.state.speed,brakeActual:h.state.brakeActual,time:h.state.time},g=ii.lastDir,v=Eh(Vs,p,aa,n,c,g,t);Vs=v.next,vi=ph(vi,n,p,t,{reasons:v.reasons});const m={chainage:d,speed:p.speed,dt:t,controls:ii,safety:vi,aws:Vs,served:Vs.served,env:a};xa.render(m),TM.update(_h(p,ii,vi,aa,Vs.served,v.hud));for(const x of Ri){if(x.kind!=="ai")continue;const E=Hd.get(x.id);if(!E)continue;const S=Ui.edges[x.pos.edgeId];E.setPose(zr(S,x.pos.s,x.pos.d)),E.setVisible(!0)}const f=Sc(ii,vi);Gd.update(uM(p.speed,ii.powerNotch/Ci,f)),Nu.clear()}requestAnimationFrame(kd);export{jr as A,Me as B,Bt as C,ce as F,Xn as H,ju as L,Fc as M,Hn as N,Xc as O,wp as R,_n as S,PM as T,yp as U,zt as V,Cn as W,U as a,ne as b,le as c,Ju as d,Qu as e,yc as f,ed as g,nd as h,td as i,Ft as j};
