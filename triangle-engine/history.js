...
(function (global) {
  ...
  var API_LEDGER = [
    ...
    { year: 1995, name: "NVLIB", who: "NVIDIA", family: "vendor",
      what: "NV1's own library, given away with the SDK. It drew quadratic patches, because that is what the chip drew — so a game written against it could not be ported to anything else, and nothing else could be ported to it.", explains: "raster" },
    ...
    { year: 1996, name: "Glide", who: "3dfx", family: "vendor",
      what: "Barely more than Voodoo's register set with names on it. Small, honest and fast, which is why 1996 games looked better on 3dfx than on anything else — and rigid, because the Voodoo's limits were baked into its types.", explains: "texture" },
    { year: 1996, name: "Speedy3D", who: "Rendition", family: "vendor",
      what: "A DOS API for the Vérité, whose chip was a programmable RISC core: you could upload your own microcode and have the card run it. The most open of all of them, on the card fewest people bought." },
    { year: 1996, name: "SGL", who: "VideoLogic and NEC", family: "vendor",
      what: "PowerVR's library, and the only way to reach tile-based deferred rendering. An architecture that different could not be expressed through anyone else's API." },
    ...
    { year: 1996, name: "QuickDraw 3D RAVE", who: "Apple", family: "vendor",
      what: "The Rendering Acceleration Virtual Engine: a vendor-NEUTRAL abstraction layer that several chip makers implemented — the same idea as Direct3D, a year earlier, on the wrong platform to win with it." },
    ...
    { year: 1997, name: "RRedline", who: "Rendition", family: "vendor",
      what: "Speedy3D's Win32 successor, arriving as the argument it was written for was being lost." },
    { year: 1997, name: "MiniGL", who: "3dfx", family: "vendor",
      what: "Not an API so much as a surrender: a cut-down OpenGL driver implementing just enough for GLQuake, written because id Software would not target Glide for it. The most successful proprietary vendor in the business shipping someone else's interface, because one developer had the leverage to insist.", explains: "pipeline" },
    ...
    { year: 1998, name: "S3 MeTaL", who: "S3 Incorporated", family: "vendor",
      what: "The last proprietary API anyone shipped a hit on. Unreal Tournament's MeTaL renderer used S3TC compression to load textures nothing else could fit — visibly better, on one brand of card, two years after that had stopped being a viable way to sell games.", explains: "texture" },
