...
(function (global) {
  ...
  var API_LEDGER = [
    ...
    { year: 1992, name: "OpenGL 1.0", when: "30 June", who: "SGI, and a new Architecture Review Board", family: "gl",
    ...
    { year: 2000, name: "DirectX 8.0", when: "November", who: "Microsoft", family: "d3d",
      what: "Programmable vertex and pixel shaders, shader model 1.1. The fixed-function pipeline becomes optional for the first time in the field's history.", explains: "shading" },
    ...
    { year: 2007, name: "CUDA 1.0", when: "February", who: "NVIDIA", family: "compute",
    ...
    { year: 2014, name: "Metal", when: "June", who: "Apple", family: "explicit",
      what: "The first of the explicit APIs to actually ship. Pipeline state objects, command buffers, and no driver guessing what you meant." },
    ...
    { year: 2017, name: "OpenGL 4.6", when: "July", who: "Khronos", family: "gl",
      what: "SPIR-V ingestion and anisotropic filtering in core. The last version of OpenGL there will ever be." },
    ...
    { year: 2020, name: "DirectX 12 Ultimate", when: "March", who: "Microsoft", family: "d3d",
    ...
    { year: 2020, name: "Vulkan Ray Tracing", when: "December", who: "Khronos", family: "explicit",
      what: "The same acceleration structures and shader stages as DXR, cross-vendor and cross-platform.", explains: "rays" },
    { year: 2023, name: "WebGPU", when: "April", who: "W3C", family: "web",
  ...
  var HARDWARE_LEDGER = [
    { year: 1984, name: "SGI IRIS 1000 / 2000", who: "Silicon Graphics", family: "workstation",
      what: "The Geometry Engine, sold first as a terminal you plugged into a real computer.", explains: "transform" },
    ...
    { year: 1995, name: "S3 ViRGE", who: "S3 Incorporated", family: "consumer",
      what: "So slow at filtered, depth-buffered 3D that it was widely nicknamed a decelerator — software was often faster." },
    { year: 1995, name: "Rendition Vérité V1000", who: "Rendition", family: "consumer",
      what: "A programmable RISC core rather than a fixed pipeline, and the first hardware Quake port — the road not taken twice over." },
    ...
    { year: 1998, name: "Sega Dreamcast", when: "November", who: "Sega and NEC", family: "console",
    ...
    { year: 1999, name: "NVIDIA GeForce 256", when: "October", who: "NVIDIA", family: "consumer",
      what: "Transform and lighting back on the card, seventeen years after SGI put them in silicon — and the coining of 'GPU'.", explains: "transform" },
    ...
    { year: 2006, name: "NVIDIA G80 / GeForce 8800 GTX", when: "November", who: "NVIDIA", family: "consumer",
      what: "Unified shaders on the desktop, DirectX 10, 128 cores in warps of 32 — and CUDA the following February.", explains: "parallel" },
    { year: 2007, name: "AMD R600 / Radeon HD 2900", who: "AMD", family: "consumer",
      what: "A VLIW unified architecture, and the first part designed after AMD bought ATI in 2006." },
    { year: 2009, name: "ATI Radeon HD 5870", when: "September", who: "AMD", family: "consumer",
    ...
    { year: 2010, name: "NVIDIA Fermi / GTX 480", who: "NVIDIA", family: "consumer",
      what: "A real cache hierarchy, ECC memory and fast double precision — a graphics chip designed as much for the datacentre." },
    { year: 2011, name: "AMD GCN / Radeon HD 7970", who: "AMD", family: "consumer",
    ...
    { year: 2018, name: "NVIDIA Turing / RTX 2080", when: "September", who: "NVIDIA", family: "consumer",
      what: "RT cores doing bounding-volume traversal and ray-triangle intersection in silicon, next to tensor cores doing the denoising.", explains: "rays" },
    ...
    { year: 2022, name: "Intel Arc Alchemist", who: "Intel", family: "consumer",
      what: "A third desktop vendor after two decades of two, with hardware ray tracing and matrix units for upscaling." },
    ...
    { year: 2023, name: "Apple M3", when: "October", who: "Apple", family: "consumer",
