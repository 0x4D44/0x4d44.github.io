...
try{
 ...
 const firstResult=await value('({eventIndex:window.__game.session.championship.eventIndex,rows:document.querySelectorAll("#result-standings tbody tr").length})');
 ...
 const championshipFlow=await value('({phase:window.__game.session.championship.phase,results:window.__game.session.championship.results.length,rows:document.querySelectorAll("#standings-table tbody tr").length})');
